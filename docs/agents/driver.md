...
cases outside the 18-fixture matrix above. Independent host-compiler execution
remains the semantic reference, with failed wide CAS requiring a validated
pair read.
