...
population also includes the required link and self-host stage rows, its even
pair count must be the largest admitted value that fits that ceiling (254 rather
than 256); no supported row is dropped.
