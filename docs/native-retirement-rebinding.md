...
The already-required `API migration policy` check refuses ordinary merge for a
candidate that changes an admitted repository source, trusted implementation,
...
a manual feature-branch rebase.
