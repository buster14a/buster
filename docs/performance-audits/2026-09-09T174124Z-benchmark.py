...
out = work / '36-winind-measurement'
out.mkdir(exist_ok=True)
binaries = {v: work / f'36-winind-{v}-ide' for v in ('before', 'after')}
cases = {
    ...
    'aggregate-windows-fast': ['cc', '-target', 'x86_64-pc-windows', '-g0', '-fregister-allocator=fast', '-v', '-c', 'tests/differential/native_aggregate.c'],
    'aggregate-aarch64-fast': ['cc', '-target', 'aarch64-unknown-linux', '-g0', '-fregister-allocator=fast', '-v', '-c', 'tests/differential/native_aggregate.c'],
