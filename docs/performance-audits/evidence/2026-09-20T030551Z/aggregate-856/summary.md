...
|---|---:|---:|---:|---:|---:|---|
| macros/fast | 187.483 | 186.443 | -0.54% | 508.96 / 513.02 | 87909 | diagnostic (guard disabled) |
| aggregate-abi/fast | 161.757 | 160.969 | -0.50% | 227.81 / 225.81 | 50898 | diagnostic (guard disabled) |
