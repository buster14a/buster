...
out = work / '36-winva-a64-v2-measurement'
out.mkdir(exist_ok=True)
binaries = {v: work / f'36-winva-a64-v2-{v}-ide' for v in ('before', 'after')}
cases = {
    ...
    'variadic-windows-fast': ['cc', '-target', 'x86_64-pc-windows', '-g0', '-fregister-allocator=fast', '-v', '-c', 'tests/differential/native_variadic.c'],
    'variadic-aarch64-fast': ['cc', '-target', 'aarch64-unknown-linux', '-g0', '-fregister-allocator=fast', '-v', '-c', 'tests/differential/native_variadic.c'],
