...
[`native-retirement-support-v1.tsv`](native-retirement-support-v1.tsv). Its 549
explicit SHA-256 rows bind every tracked test byte at the approval point: 403
subject inputs (397 supported-object subjects and 6 registered non-object
