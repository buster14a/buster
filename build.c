...
BUSTER_IMPL ProcessResult process_arguments()
{
...

    {
        ...
        // if (arg_ptr != arg_top)
        // {
        //     let arg_value_pointer = *arg_ptr;
        //     let a = (OsString){arg_value_pointer, os_string_length(arg_value_pointer)};
        //     arg_ptr += 1;
        //
        //     if (os_string_compare(a, OsS("test")))
        //     {
        //         build_program_state.command = BUILD_COMMAND_TEST;
        //     }
        //     else if (os_string_compare(a, OsS("debug")))
        //     {
        ...
        //         result = buster_argument_process(argc, argv, envp, argument_index);
        //
