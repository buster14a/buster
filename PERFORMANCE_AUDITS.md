...
- [`2026-08-22T203845Z`](docs/performance-audits/2026-08-22T203845Z.md) — the window lexer's three standing census leads taken together: carry-propagated number extents, register-blended punctuator ids, and sixteen-row token stores (stage 1 -30,0 M instructions)
- [`2026-08-22T205418Z`](docs/performance-audits/2026-08-22T205418Z.md) — the AArch64 machine backend's fifth installment — vector literals and chunked NEON arithmetic, atomics, ELF thread locals, dynamic stack allocation, SWITCH terminators, and the sub-sixteen-byte vector ABI take the census from 790 to 962 of 990
- [`2026-08-22T205418Z`](docs/performance-audits/2026-08-22T205418Z.md) — the AArch64 machine backend's fifth installment — vector literals and chunked NEON arithmetic, atomics, ELF thread locals, dynamic stack allocation, SWITCH terminators, and the sub-sixteen-byte vector ABI take the census from 790 to 970 of 998, plus two wrong-answer AArch64 bugs older than the branch
...
- [`2026-08-22T220912Z`](docs/performance-audits/2026-08-22T220912Z.md) — census the parser side against the Accelerated Zig Parser: the upstream parser kernels do not exist, and the ranked token-walk ceilings say the token census is the one that pays
...
- [`2026-08-22T150012Z`](docs/performance-audits/2026-08-22T150012Z.md) — the AArch64 machine backend's fourth installment — variadic definitions, short-vector and indirect signatures, stack aggregates, over-aligned locals, and the rvalue INDEX snapshot close four census classes (223 to 252 of 294)
- [`2026-08-22T144241Z`](docs/performance-audits/2026-08-22T144241Z.md) — re-rank both miss surveys on post-497/499/500/501 main, then stop the IR lowering re-deriving what the parse pass already indexed
- [`2026-08-22T141319Z`](docs/performance-audits/2026-08-22T141319Z.md) — the two indirect dispatches of the branch-miss survey: the lowering machine stops re-dispatching its fixed chains, and the selector's switch is measured in place
- [`2026-08-22T140940Z`](docs/performance-audits/2026-08-22T140940Z.md) — SIMD-first lexing evaluated against the landed compaction emitter: a census of the stage-1 workload, the window pipeline's lane utilization, and 64-byte-stride escape scans (stage 1 -37,0 M instructions)
