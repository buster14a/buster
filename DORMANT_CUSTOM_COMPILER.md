# Dormant custom compiler reference
...
`AGENTS.md` for current work, and reconcile this material with the current
compiler before reactivating any dormant subsystem.
