...
class WorkflowPolicyTests(unittest.TestCase):
    ...
    def test_retirement_evidence_uses_the_exact_candidate_on_six_native_hosts(self):
        ...
        self.assertIn("TRUSTED_REF: ${{ github.event.pull_request.base.sha || github.sha }}", text)
        ...
        ordered = ["../trusted/tools/native_retirement_integration.py classify",
                   "../trusted/tools/native_retirement_external.py prepare",
