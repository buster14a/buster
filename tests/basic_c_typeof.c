...
int main(void)
{
    ...
    typeof(&global_value) pointer_from_expression =
        &global_value;
    typeof(*pointer_from_expression) copied_value =
        *pointer_from_expression;
    ...
    typeof(global_value ? 1l : 2l) conditional_value =
        global_value ? 23 : 29;
    ...
    mutable_value += 1;
    return same_qualification == 3 &&
            mutable_value == 4 &&
            *pointer_from_type == 7 &&
            *pointer_from_expression == 7 &&
            copied_value == 7 &&
            field_value == 11 &&
            sizeof(copied_values) == sizeof(values) &&
            copied_values[2] == 13 &&
            element_value == 5 &&
            arithmetic_value == 19 &&
            floating_value == 3.5f &&
            call_value == 17ul &&
            cast_value == 7 &&
            conditional_value == 23 &&
            comma_value == 31ul &&
            size_value == sizeof(values) &&
            sizeof(text_value) == 4 &&
            text_value[2] == 'c' ?
        0 :
        1;
