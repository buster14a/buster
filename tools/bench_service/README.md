...
| Durable service identity/recovery | intent plus immutable invocation/cgroup-inode binding; same-boot exact termination, same-name reuse quarantine, reboot interruption without contradicting a durable outcome |
