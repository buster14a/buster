 ...
 * Launch status, command identity and independent runtime oracle remain the
 * trusted service runner's responsibility.
 */
...
{
    bool ok = gate && !gate->failed && !gate->finished && observed && locations &&
