...
BUSTER_GLOBAL_LOCAL BqError bq_test_worker_start(BqWorkerBackend* backend, char const* const* argv, u32 count)
{
    ...
    fake->argv_valid = count == 52 && !strcmp(argv[0], BQ_SYSTEMD_RUN) && !strcmp(argv[1], "--quiet") &&
        ...
        !strcmp(argv[15], "--property=RuntimeMaxSec=432000000000us") &&
...
BUSTER_GLOBAL_LOCAL bool bq_test_worker_begin(BqWorkerFixture* fixture, BqWorkerResult result, bool detached)
{
    *fixture = (BqWorkerFixture){0};
    ...
    fixture->fake.observed.runtime_max_usec = 5ull * 24 * 60 * 60 * 1000000;
    ...
    fixture->config = (BqWorkerConfig){
        ...
        .limits = {2, 8ull * 1024 * 1024 * 1024, 0, 256, 5ull * 24 * 60 * 60 * 1000000},
...
{
    u64 bundle_limit = 0;
    BQ_CHECK(bq_worker_bundle_decimal("2147483648", BQ_WORKER_BUNDLE_FILE_CAP, &bundle_limit) &&
             bundle_limit == BQ_WORKER_BUNDLE_FILE_CAP);
    BQ_CHECK(!bq_worker_bundle_decimal("2147483649", BQ_WORKER_BUNDLE_FILE_CAP, &bundle_limit));
    BQ_CHECK(bq_worker_bundle_decimal("17179869184", BQ_WORKER_BUNDLE_TOTAL_CAP, &bundle_limit) &&
             bundle_limit == BQ_WORKER_BUNDLE_TOTAL_CAP);
    BQ_CHECK(!bq_worker_bundle_decimal("17179869185", BQ_WORKER_BUNDLE_TOTAL_CAP, &bundle_limit));
    BqWorkerFixture fixture;
    if (bq_test_worker_begin(&fixture, BQ_WORKER_SUCCEEDED, false))
    {
        BqQueue* queue = &fixture.material.queue.queue;
