...
int main()
{
    ...
    let minimal_gpt = file_read(arena, S("build/minimal_gpt.img"), (FileReadOptions){});
    ...
    u64 expected_size = BUSTER_MB(2) + gpt_partition_entry_count * sector_size;
    ...
    *gpt_header = (GPTHeader) {
    ...
    u8 guid[] = { 0x5b, 0x8b, 0x54, 0x17, 0x22, 0xc9, 0xf0, 0x4d, 0x8c, 0xc5, 0x98, 0xe2, 0xe8, 0xa1, 0xe8, 0x44 };
    ...
    u64 starting_lba = 0x800;

    *gpt_partition_entry = (GPTPartitionEntry) {
        .starting_lba = starting_lba,
        .ending_lba = starting_lba + (BUSTER_MB(1) / sector_size) - 1,
        .attributes = 0,
    };
