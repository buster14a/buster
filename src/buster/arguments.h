...
#define flag_get(arr, e) flag_get_ex((arr), (BUSTER_UNDERLYING_TYPE(decltype(e))) decltype(e)::Count, (BUSTER_UNDERLYING_TYPE(decltype(e)))(e))
#define flag_set(arr, e, v) flag_set_ex((arr), (BUSTER_UNDERLYING_TYPE(decltype(e))) decltype(e)::Count, (BUSTER_UNDERLYING_TYPE(decltype(e)))(e), (v))
