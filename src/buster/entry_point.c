...
BUSTER_LOCAL ProcessResult buster_entry_point(int argc, OsStringList argv, OsStringList envp)
{
...
{
    let result = buster_entry_point(argc, (OsStringList)argv, (OsStringList)envp);
    return (int)result;
}
#else
#endif
