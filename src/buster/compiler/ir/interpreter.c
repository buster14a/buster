...
BUSTER_GLOBAL_LOCAL IrExecutionTarget ir_interpreter_function_find(AnalysisProgram* analysis, IrProgram* program, AnalysisEntityId entity,
                                                                   AnalysisInstantiationId instantiation)
{
...
BUSTER_GLOBAL_LOCAL f64 ir_interpreter_float_read(u64 bits, u32 width)
{
    if (width == 32)
    {
        u32 bits32 = (u32)bits;
