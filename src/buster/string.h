...
BUSTER_DECL String8 string16_to_string8_arena(Arena* arena, String16 s, bool null_terminate);
BUSTER_DECL String16 string8_to_string16_arena(Arena* arena, String8 s, bool null_terminate);
