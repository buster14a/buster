...
//   ./scrape_llvm /path/to/llvm --generate-output src/buster/lib/x86_64_llvm.c

#include <buster/lib/base.h>
#include <buster/lib/system_headers.h>
#include <buster/lib/arena.h>
#include <buster/lib/string8.h>
...
BUSTER_IMPL ProcessResult thread_entry_point()
{
    ...
    StringOs output_path = scrape_llvm_program_state.generate_output.pointer ? scrape_llvm_program_state.generate_output : S8("src/buster/lib/x86_64_llvm.c");
