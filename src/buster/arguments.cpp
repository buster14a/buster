...
BUSTER_F_IMPL bool flag_get_ex(u64* flag_pointer, u64 flag_count, u64 flag_index)
{
    BUSTER_CHECK(flag_index < flag_count);
    u64 divisor = sizeof(*flag_pointer);
    let element_index = flag_index / divisor;
...
BUSTER_F_IMPL BooleanArgumentProcessResult boolean_argument_process(StringOs* flag_string_start_pointer, u64 flag_string_start_count, u64* flag_pointer, u64 flag_count, StringOs argument)
{
