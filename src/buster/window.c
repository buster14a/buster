...
#if BUSTER_LINUX
#include <buster/window/xcb.c>
#elif defined(_WIN32)
#include <buster/window/win32.c>
#elif defined(__APPLE__)
#include <buster/window/apple.c>
#if BUSTER_IOS
#include <buster/window/ios.c>
#endif
#elif BUSTER_ANDROID
#include <buster/window/android.c>
#else
#include <buster/window/null.c>
#endif
