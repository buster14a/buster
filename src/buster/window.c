...
BUSTER_GLOBAL_LOCAL WmEvent* wm_event_push(WmEvent event)
{
    WmEvent* result = arena_allocate(windowing_handle.event_arena, WmEvent, 1);
    *result = event;

    if (windowing_handle.event_list.last)
    {
        result->previous = windowing_handle.event_list.last;
        windowing_handle.event_list.last->next = result;
    }
    else
    {
        windowing_handle.event_list.first = result;
    }

    windowing_handle.event_list.last = result;
    windowing_handle.event_list.count += 1;
    return result;
}
...
{
    u32 result = XCB_EVENT_MASK_KEY_PRESS |
        ...
        handle->xim_forward_event_mask |
        handle->xim_synchronous_event_mask;
    return result;
}
...
BUSTER_GLOBAL_LOCAL u8 wm_x11_modifiers_from_state(uint16_t state)
{
    ...
    return (u8)(
            ((u8)mod_control << WM_MODIFIER_CONTROL) |
            ((u8)mod_shift << WM_MODIFIER_SHIFT) |
            ((u8)mod_alt << WM_MODIFIER_ALT));
}
...
BUSTER_GLOBAL_LOCAL WmKey wm_x11_key_from_xkb_name(const char* name)
{
    ...
    if (name)
    {
        if (strcmp(name, "ESC") == 0) result = WM_KEY_ESC;
        else if (strcmp(name, "FK01") == 0) result = WM_KEY_F1;
        else if (strcmp(name, "FK02") == 0) result = WM_KEY_F2;
        else if (strcmp(name, "FK03") == 0) result = WM_KEY_F3;
        else if (strcmp(name, "FK04") == 0) result = WM_KEY_F4;
        else if (strcmp(name, "FK05") == 0) result = WM_KEY_F5;
        else if (strcmp(name, "FK06") == 0) result = WM_KEY_F6;
        else if (strcmp(name, "FK07") == 0) result = WM_KEY_F7;
        else if (strcmp(name, "FK08") == 0) result = WM_KEY_F8;
        else if (strcmp(name, "FK09") == 0) result = WM_KEY_F9;
        else if (strcmp(name, "FK10") == 0) result = WM_KEY_F10;
        else if (strcmp(name, "FK11") == 0) result = WM_KEY_F11;
        else if (strcmp(name, "FK12") == 0) result = WM_KEY_F12;
        else if (strcmp(name, "FK13") == 0) result = WM_KEY_F13;
        else if (strcmp(name, "FK14") == 0) result = WM_KEY_F14;
        else if (strcmp(name, "FK15") == 0) result = WM_KEY_F15;
        else if (strcmp(name, "FK16") == 0) result = WM_KEY_F16;
        else if (strcmp(name, "FK17") == 0) result = WM_KEY_F17;
        else if (strcmp(name, "FK18") == 0) result = WM_KEY_F18;
        else if (strcmp(name, "FK19") == 0) result = WM_KEY_F19;
        else if (strcmp(name, "FK20") == 0) result = WM_KEY_F20;
        else if (strcmp(name, "FK21") == 0) result = WM_KEY_F21;
        else if (strcmp(name, "FK22") == 0) result = WM_KEY_F22;
        else if (strcmp(name, "FK23") == 0) result = WM_KEY_F23;
        else if (strcmp(name, "FK24") == 0) result = WM_KEY_F24;
        else if (strcmp(name, "FK25") == 0) result = WM_KEY_F25;
        else if (strcmp(name, "FK26") == 0) result = WM_KEY_F26;
        else if (strcmp(name, "FK27") == 0) result = WM_KEY_F27;
        else if (strcmp(name, "FK28") == 0) result = WM_KEY_F28;
        else if (strcmp(name, "FK29") == 0) result = WM_KEY_F29;
        else if (strcmp(name, "FK30") == 0) result = WM_KEY_F30;
        else if (strcmp(name, "FK31") == 0) result = WM_KEY_F31;
        else if (strcmp(name, "FK32") == 0) result = WM_KEY_F32;
        else if (strcmp(name, "FK33") == 0) result = WM_KEY_F33;
        else if (strcmp(name, "FK34") == 0) result = WM_KEY_F34;
        else if (strcmp(name, "FK35") == 0) result = WM_KEY_F35;
        else if (strcmp(name, "TLDE") == 0) result = WM_KEY_BACKTICK;
        else if (strcmp(name, "AE01") == 0) result = WM_KEY_1;
        else if (strcmp(name, "AE02") == 0) result = WM_KEY_2;
        else if (strcmp(name, "AE03") == 0) result = WM_KEY_3;
        else if (strcmp(name, "AE04") == 0) result = WM_KEY_4;
        else if (strcmp(name, "AE05") == 0) result = WM_KEY_5;
        else if (strcmp(name, "AE06") == 0) result = WM_KEY_6;
        else if (strcmp(name, "AE07") == 0) result = WM_KEY_7;
        else if (strcmp(name, "AE08") == 0) result = WM_KEY_8;
        else if (strcmp(name, "AE09") == 0) result = WM_KEY_9;
        else if (strcmp(name, "AE10") == 0) result = WM_KEY_0;
        else if (strcmp(name, "AE11") == 0) result = WM_KEY_MINUS;
        else if (strcmp(name, "AE12") == 0) result = WM_KEY_EQUAL;
        else if (strcmp(name, "BKSP") == 0) result = WM_KEY_BACKSPACE;
        else if (strcmp(name, "TAB") == 0) result = WM_KEY_TAB;
        else if (strcmp(name, "AD01") == 0) result = WM_KEY_Q;
        else if (strcmp(name, "AD02") == 0) result = WM_KEY_W;
        else if (strcmp(name, "AD03") == 0) result = WM_KEY_E;
        else if (strcmp(name, "AD04") == 0) result = WM_KEY_R;
        else if (strcmp(name, "AD05") == 0) result = WM_KEY_T;
        else if (strcmp(name, "AD06") == 0) result = WM_KEY_Y;
        else if (strcmp(name, "AD07") == 0) result = WM_KEY_U;
        else if (strcmp(name, "AD08") == 0) result = WM_KEY_I;
        else if (strcmp(name, "AD09") == 0) result = WM_KEY_O;
        else if (strcmp(name, "AD10") == 0) result = WM_KEY_P;
        else if (strcmp(name, "AD11") == 0) result = WM_KEY_LEFT_BRACKET;
        else if (strcmp(name, "AD12") == 0) result = WM_KEY_RIGHT_BRACKET;
        else if (strcmp(name, "BKSL") == 0) result = WM_KEY_BACKWARD_SLASH;
        else if (strcmp(name, "RTRN") == 0) result = WM_KEY_RETURN;
        else if (strcmp(name, "CAPS") == 0) result = WM_KEY_CAPS_LOCK;
        else if (strcmp(name, "AC01") == 0) result = WM_KEY_A;
        else if (strcmp(name, "AC02") == 0) result = WM_KEY_S;
        else if (strcmp(name, "AC03") == 0) result = WM_KEY_D;
        else if (strcmp(name, "AC04") == 0) result = WM_KEY_F;
        else if (strcmp(name, "AC05") == 0) result = WM_KEY_G;
        else if (strcmp(name, "AC06") == 0) result = WM_KEY_H;
        else if (strcmp(name, "AC07") == 0) result = WM_KEY_J;
        else if (strcmp(name, "AC08") == 0) result = WM_KEY_K;
        else if (strcmp(name, "AC09") == 0) result = WM_KEY_L;
        else if (strcmp(name, "AC10") == 0) result = WM_KEY_SEMICOLON;
        else if (strcmp(name, "AC11") == 0) result = WM_KEY_SINGLE_QUOTE;
        else if (strcmp(name, "LFSH") == 0) result = WM_KEY_SHIFT;
        else if (strcmp(name, "RTSH") == 0) result = WM_KEY_SHIFT;
        else if (strcmp(name, "AB01") == 0) result = WM_KEY_Z;
        else if (strcmp(name, "AB02") == 0) result = WM_KEY_X;
        else if (strcmp(name, "AB03") == 0) result = WM_KEY_C;
        else if (strcmp(name, "AB04") == 0) result = WM_KEY_V;
        else if (strcmp(name, "AB05") == 0) result = WM_KEY_B;
        else if (strcmp(name, "AB06") == 0) result = WM_KEY_N;
        else if (strcmp(name, "AB07") == 0) result = WM_KEY_M;
        else if (strcmp(name, "AB08") == 0) result = WM_KEY_COMMA;
        else if (strcmp(name, "AB09") == 0) result = WM_KEY_DOT;
        else if (strcmp(name, "AB10") == 0) result = WM_KEY_FORWARD_SLASH;
        else if (strcmp(name, "LCTL") == 0) result = WM_KEY_CONTROL;
        else if (strcmp(name, "RCTL") == 0) result = WM_KEY_CONTROL;
        else if (strcmp(name, "LALT") == 0) result = WM_KEY_ALT;
        else if (strcmp(name, "RALT") == 0) result = WM_KEY_ALT;
        else if (strcmp(name, "SPCE") == 0) result = WM_KEY_SPACE;
        else if (strcmp(name, "COMP") == 0) result = WM_KEY_MENU;
        else if (strcmp(name, "MENU") == 0) result = WM_KEY_MENU;
        else if (strcmp(name, "INS") == 0) result = WM_KEY_INSERT;
        else if (strcmp(name, "HOME") == 0) result = WM_KEY_HOME;
        else if (strcmp(name, "PGUP") == 0) result = WM_KEY_PAGE_UP;
        else if (strcmp(name, "DELE") == 0) result = WM_KEY_DELETE;
        else if (strcmp(name, "END") == 0) result = WM_KEY_END;
        else if (strcmp(name, "PGDN") == 0) result = WM_KEY_PAGE_DOWN;
        else if (strcmp(name, "UP") == 0) result = WM_KEY_UP;
        else if (strcmp(name, "DOWN") == 0) result = WM_KEY_DOWN;
        else if (strcmp(name, "LEFT") == 0) result = WM_KEY_LEFT;
        else if (strcmp(name, "RGHT") == 0) result = WM_KEY_RIGHT;
        else if (strcmp(name, "NMLK") == 0) result = WM_KEY_NUM_LOCK;
        else if (strcmp(name, "KPDV") == 0) result = WM_KEY_NUM_SLASH;
        else if (strcmp(name, "KPMU") == 0) result = WM_KEY_NUM_STAR;
        else if (strcmp(name, "KPSU") == 0) result = WM_KEY_NUM_MINUS;
        else if (strcmp(name, "KPAD") == 0) result = WM_KEY_NUM_PLUS;
        else if (strcmp(name, "KPEN") == 0) result = WM_KEY_RETURN;
        else if (strcmp(name, "KPDL") == 0) result = WM_KEY_NUM_DOT;
        else if (strcmp(name, "KP0") == 0) result = WM_KEY_NUM_0;
        else if (strcmp(name, "KP1") == 0) result = WM_KEY_NUM_1;
        else if (strcmp(name, "KP2") == 0) result = WM_KEY_NUM_2;
        else if (strcmp(name, "KP3") == 0) result = WM_KEY_NUM_3;
        else if (strcmp(name, "KP4") == 0) result = WM_KEY_NUM_4;
        else if (strcmp(name, "KP5") == 0) result = WM_KEY_NUM_5;
        else if (strcmp(name, "KP6") == 0) result = WM_KEY_NUM_6;
        else if (strcmp(name, "KP7") == 0) result = WM_KEY_NUM_7;
        else if (strcmp(name, "KP8") == 0) result = WM_KEY_NUM_8;
        else if (strcmp(name, "KP9") == 0) result = WM_KEY_NUM_9;
    }
...
BUSTER_GLOBAL_LOCAL void wm_x11_xkb_select_events(WmHandle* handle)
{
    ...
    {
        u16 event_mask = XCB_XKB_EVENT_TYPE_NEW_KEYBOARD_NOTIFY |
            XCB_XKB_EVENT_TYPE_MAP_NOTIFY |
            XCB_XKB_EVENT_TYPE_STATE_NOTIFY;
        u16 keyboard_details = XCB_XKB_NKN_DETAIL_KEYCODES |
            XCB_XKB_NKN_DETAIL_DEVICE_ID;
        u16 state_details = XCB_XKB_STATE_PART_MODIFIER_STATE |
        ...
        u16 map_parts = XCB_XKB_MAP_PART_KEY_TYPES |
        ...
        xcb_xkb_select_events_aux(handle->connection,
                                  (xcb_xkb_device_spec_t)handle->xkb_device_id,
                                  event_mask,
                                  0,
                                  event_mask,
                                  map_parts,
...
{
    u8 base_event = 0;
    if (xkb_x11_setup_xkb_extension(handle->connection,
...
BUSTER_GLOBAL_LOCAL bool wm_x11_handle_xkb_event(WmHandle* handle, xcb_generic_event_t* event)
{
    ...
    {
        break; case XCB_XKB_NEW_KEYBOARD_NOTIFY:
        {
            wm_x11_xkb_deinitialize(handle);
            wm_x11_xkb_initialize(handle);
        }
        break; case XCB_XKB_MAP_NOTIFY:
        {
            wm_x11_xkb_refresh_keymap(handle);
        }
        break; case XCB_XKB_STATE_NOTIFY:
        {
...
BUSTER_GLOBAL_LOCAL bool wm_xim_select_input_style(WmHandle* handle, WmWindowHandle* window, u32* input_style_out)
{
    u32 candidates[] = {
        ...
        XCB_IM_PreeditNone | XCB_IM_StatusNothing,
    ...
    if (reply)
    {
        for (u32 attribute_index = 0; attribute_index < reply->im_attribute_returned.size; attribute_index += 1)
        {
            ...
            if (attribute->value && attribute->value_length >= 4)
            {
                ...
                u32 value_offset = 4;
                for (u32 style_index = 0;
                        style_index < style_count &&
                        value_offset + 4 <= attribute->value_length &&
...
BUSTER_GLOBAL_LOCAL void wm_xim_set_event_mask_callback(xcb_xim_t *im, xcb_xic_t ic, uint32_t forward_event_mask, uint32_t synchronous_event_mask, void *user_data)
{
    BUSTER_UNUSED(im);
...
BUSTER_GLOBAL_LOCAL void wm_xim_commit_string_callback(xcb_xim_t *im, xcb_xic_t ic, uint32_t flag, char *str, uint32_t length, uint32_t *keysym, size_t keysym_count, void *user_data)
{
    BUSTER_UNUSED(flag);
    ...
    if (handle->xim && handle->xim_open && window->handle && !window->ic && !window->xim_create_ic_pending)
    {
        if (!handle->xim_input_styles_ready)
        {
            if (!handle->xim_input_styles_pending)
            {
                ...
                if (!xcb_xim_get_im_values(handle->xim,
                                           wm_xim_get_im_values_callback,
                                           handle,
        ...
        if (handle->xim_input_styles_ready && wm_xim_select_input_style(handle, window, &input_style))
        {
            ...
            {
                xcb_point_t spot = {0};
                xcb_xim_nested_list preedit = xcb_xim_create_nested_list(handle->xim,
                                                                         XCB_XIM_XNSpotLocation, &spot,
                                                                         NULL);
                if (preedit.data && preedit.length)
                {
                    requested = xcb_xim_create_ic(handle->xim,
                                                  wm_xim_create_ic_callback,
                                                  window,
                                                  XCB_XIM_XNInputStyle, &input_style,
                                                  XCB_XIM_XNClientWindow, &window->handle,
                                                  XCB_XIM_XNFocusWindow, &window->handle,
                                                  XCB_XIM_XNPreeditAttributes, &preedit,
                                                  NULL);
                }
                free(preedit.data);
            }
...
WmWindowHandle* wm_window_create(WmHandle* windowing, WmWindowCreate create)
{
    ...
    window = ((id (*)(id, SEL, BusterCGRect, BusterNSUInteger, BusterNSUInteger, bool))objc_msgSend)(window, buster_sel("initWithContentRect:styleMask:backing:defer:"), content_rect, style_mask, backing_store_buffered, defer_creation);
    ...
    HWND window_handle = CreateWindowExW(
            ...
            use_default_position ? CW_USEDEFAULT : 0, // TODO
            use_default_position ? CW_USEDEFAULT : 0, // TODO
            create.size.width,
            create.size.height,
            0,
...
WmEventList wm_poll_events(Arena* arena, WmHandle* windowing)
{
    ...
    while (true)
    {
        ...
        id event = ((id (*)(id, SEL, BusterNSUInteger, id, id, bool))objc_msgSend)(windowing->application, buster_sel("nextEventMatchingMask:untilDate:inMode:dequeue:"), any_event_mask, distant_past, buster_apple_run_loop_mode, true);
        if (!event)
        {
            break;
        }
