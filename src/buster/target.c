...
{
    StringOs arch_string = cpu_arch_to_string_os(target.cpu_arch);
    StringOs string_os = operating_system_to_string_os(target.os);
    StringOs model_string = cpu_model_to_string_os(target.cpu_model);
...
StringOs cpu_arch_to_string_os(CpuArch arch)
{
    switch (arch)
    {
...
StringOs operating_system_to_string_os(OperatingSystem os)
{
    switch (os)
    {
...
StringOs cpu_model_to_string_os(CpuModel model)
{
    switch (model)
    {
