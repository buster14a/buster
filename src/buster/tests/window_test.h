...
BUSTER_TEST_F_DECL u64 wm_native_file_drop_max_path_count(void);
BUSTER_TEST_F_DECL u64 wm_native_file_drop_max_path_bytes(void);
BUSTER_TEST_F_DECL bool wm_native_file_drop_budget_allows(u64 path_count, u64 output_bytes);
BUSTER_TEST_F_DECL bool wm_native_file_drop_array_size_allowed(u64 count, u64 element_size);
