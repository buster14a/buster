...
UnitTestResult compiler_driver_tests(UnitTestArguments* arguments)
{
    ...
    UnitTestResult float_to_f128 = compiler_driver_test_aarch64_float_to_f128(arguments);
    result.test_count += float_to_f128.test_count;
    result.succeeded_test_count += float_to_f128.succeeded_test_count;
    ...
    UnitTestResult frame_vectors = compiler_driver_test_native_frame_vectors(arguments);
