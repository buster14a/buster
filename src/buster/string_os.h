...
#define string_os_to_string8(a, s) string16_to_string8(a, s)
...
#define string_os_format_arena(arena, format, ...) arena_string16_format(arena, true, format, __VA_ARGS__)
...
#define string_os_to_string8(a, s) s
