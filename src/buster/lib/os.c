...
void os_resource_test_fail_after(OsResourceTestOperation operation, u64 successful_operations_before_failure)
{
...
BUSTER_GLOBAL_LOCAL ThreadContext* thread_context_allocate_attempt(void)
{
