...
#define X64_DIRECT(opcode, index) [opcode] = MACHINE_RECIPE_DIRECT(index),
    X64_DIRECT(MACHINE_X64_MOV_RR, 0)
    X64_DIRECT(MACHINE_X64_MOV32_RR, 1)
    X64_DIRECT(MACHINE_X64_MOVSX8_RR, 2)
    X64_DIRECT(MACHINE_X64_MOVSX16_RR, 3)
    X64_DIRECT(MACHINE_X64_MOVSX32_RR, 4)
    X64_DIRECT(MACHINE_X64_MOVZX8_RR, 5)
    X64_DIRECT(MACHINE_X64_MOVZX16_RR, 6)
    X64_DIRECT(MACHINE_X64_ADD32, 7)
    X64_DIRECT(MACHINE_X64_ADD64, 8)
    X64_DIRECT(MACHINE_X64_SUB32, 9)
    X64_DIRECT(MACHINE_X64_SUB64, 10)
    X64_DIRECT(MACHINE_X64_AND32, 11)
    X64_DIRECT(MACHINE_X64_AND64, 12)
    X64_DIRECT(MACHINE_X64_OR32, 13)
    X64_DIRECT(MACHINE_X64_OR64, 14)
    X64_DIRECT(MACHINE_X64_XOR32, 15)
    X64_DIRECT(MACHINE_X64_XOR64, 16)
    X64_DIRECT(MACHINE_X64_IMUL32, 17)
    X64_DIRECT(MACHINE_X64_IMUL64, 18)
    X64_DIRECT(MACHINE_X64_NEG32, 19)
    X64_DIRECT(MACHINE_X64_NEG64, 20)
    X64_DIRECT(MACHINE_X64_NOT32, 21)
    X64_DIRECT(MACHINE_X64_NOT64, 22)
    X64_DIRECT(MACHINE_X64_BSF32, 23)
    X64_DIRECT(MACHINE_X64_BSF64, 24)
    X64_DIRECT(MACHINE_X64_BSR32, 25)
    X64_DIRECT(MACHINE_X64_BSR64, 26)
    X64_DIRECT(MACHINE_X64_POPCNT32, 27)
    X64_DIRECT(MACHINE_X64_POPCNT64, 28)
    X64_DIRECT(MACHINE_X64_CMP32, 29)
    X64_DIRECT(MACHINE_X64_CMP64, 30)
    X64_DIRECT(MACHINE_X64_TEST_RR, 31)
    X64_DIRECT(MACHINE_X64_JMP, 32)
    X64_DIRECT(MACHINE_X64_SHL32, 33)
    X64_DIRECT(MACHINE_X64_SHL64, 34)
    X64_DIRECT(MACHINE_X64_SAR32, 35)
    X64_DIRECT(MACHINE_X64_SAR64, 36)
    X64_DIRECT(MACHINE_X64_SHR32, 37)
    X64_DIRECT(MACHINE_X64_SHR64, 38)
    X64_DIRECT(MACHINE_X64_LEA_SYMBOL, 39)
    X64_DIRECT(MACHINE_X64_MOVQ_TO_XMM, 40)
    X64_DIRECT(MACHINE_X64_MOVQ_FROM_XMM, 41)
    X64_DIRECT(MACHINE_X64_LOAD_INCOMING, 42)
    X64_DIRECT(MACHINE_X64_PUSH_REGISTER, 43)
    X64_DIRECT(MACHINE_X64_ADD_RSP, 44)
    X64_DIRECT(MACHINE_X64_MFENCE, 45)
    X64_DIRECT(MACHINE_X64_INT3, 46)
#undef X64_DIRECT
#define X64_FAMILY(opcode, index) [opcode] = MACHINE_RECIPE_FAMILY(index),
    X64_FAMILY(MACHINE_X64_MOV_RI, 0)
    X64_FAMILY(MACHINE_X64_LEA_OFFSET, 1)
    X64_FAMILY(MACHINE_X64_ADD64_IMM, 2)
    X64_FAMILY(MACHINE_X64_IMUL64_RRI, 3)
    X64_FAMILY(MACHINE_X64_LOAD_FRAME, 4)
    X64_FAMILY(MACHINE_X64_STORE_FRAME8, 5)
    X64_FAMILY(MACHINE_X64_STORE_FRAME16, 6)
    X64_FAMILY(MACHINE_X64_STORE_FRAME32, 7)
    X64_FAMILY(MACHINE_X64_STORE_FRAME64, 8)
    X64_FAMILY(MACHINE_X64_LOAD_PTR8, 9)
    X64_FAMILY(MACHINE_X64_LOAD_PTR16, 10)
    X64_FAMILY(MACHINE_X64_LOAD_PTR32, 11)
    X64_FAMILY(MACHINE_X64_LOAD_PTR64, 12)
    X64_FAMILY(MACHINE_X64_STORE_PTR8, 13)
    X64_FAMILY(MACHINE_X64_STORE_PTR16, 14)
    X64_FAMILY(MACHINE_X64_STORE_PTR32, 15)
    X64_FAMILY(MACHINE_X64_STORE_PTR64, 16)
    X64_FAMILY(MACHINE_X64_LEA_FRAME, 17)
    X64_FAMILY(MACHINE_X64_PUSH_FRAME, 18)
    X64_FAMILY(MACHINE_X64_VMOV_RR, 19)
    X64_FAMILY(MACHINE_X64_VLOAD_FRAME, 20)
    X64_FAMILY(MACHINE_X64_VSTORE_FRAME, 21)
    X64_FAMILY(MACHINE_X64_VLOAD_PTR, 22)
    X64_FAMILY(MACHINE_X64_VSTORE_PTR, 23)
    X64_FAMILY(MACHINE_X64_VPSLLD_RI, 24)
    X64_FAMILY(MACHINE_X64_VBINARY, 25)
    X64_FAMILY(MACHINE_X64_CVT_F32_TO_F64, 26)
    X64_FAMILY(MACHINE_X64_CVT_F64_TO_F32, 27)
    X64_FAMILY(MACHINE_X64_CVT_I64_TO_F32, 28)
    X64_FAMILY(MACHINE_X64_CVT_I64_TO_F64, 29)
    X64_FAMILY(MACHINE_X64_CVT_F32_TO_I64, 30)
    X64_FAMILY(MACHINE_X64_CVT_F64_TO_I64, 31)
    X64_FAMILY(MACHINE_X64_VSPLATB, 32)
    X64_FAMILY(MACHINE_X64_VPTERNLOGD, 33)
    X64_FAMILY(MACHINE_X64_ATOMIC_STORE_XCHG, 34)
    X64_FAMILY(MACHINE_X64_ATOMIC_CMPXCHG, 35)
    X64_FAMILY(MACHINE_X64_VLOAD_PTR_MASKED, 36)
    X64_FAMILY(MACHINE_X64_VSTORE_PTR_MASKED, 37)
    X64_FAMILY(MACHINE_X64_VCOMPRESS_STORE_PTR, 38)
    X64_FAMILY(MACHINE_X64_VPCMP_MASK, 39)
    X64_FAMILY(MACHINE_X64_VPMOVB2M, 40)
    X64_FAMILY(MACHINE_X64_VPERMT2B, 41)
    X64_FAMILY(MACHINE_X64_VCOMPRESSB, 42)
    X64_FAMILY(MACHINE_X64_VPMOVZXBD, 43)
    X64_FAMILY(MACHINE_X64_FARITH, 44)
    X64_FAMILY(MACHINE_X64_FCMP_SET, 45)
    X64_FAMILY(MACHINE_X64_SUB_RSP, 46)
    X64_FAMILY(MACHINE_X64_SETCC, 47)
    X64_FAMILY(MACHINE_X64_JCC, 48)
#undef X64_FAMILY
#define X64_EXPANSION(opcode, index) [opcode] = MACHINE_RECIPE_EXPANSION(index),
    X64_EXPANSION(MACHINE_X64_CVT_U64_TO_F32, 0)
    X64_EXPANSION(MACHINE_X64_CVT_U64_TO_F64, 1)
    X64_EXPANSION(MACHINE_X64_CVT_F32_TO_U64, 2)
    X64_EXPANSION(MACHINE_X64_CVT_F64_TO_U64, 3)
    X64_EXPANSION(MACHINE_X64_RET, 4)
    X64_EXPANSION(MACHINE_X64_SDIV32, 5)
    X64_EXPANSION(MACHINE_X64_SDIV64, 6)
    X64_EXPANSION(MACHINE_X64_UDIV32, 7)
    X64_EXPANSION(MACHINE_X64_UDIV64, 8)
    X64_EXPANSION(MACHINE_X64_SREM32, 9)
    X64_EXPANSION(MACHINE_X64_SREM64, 10)
    X64_EXPANSION(MACHINE_X64_UREM32, 11)
    X64_EXPANSION(MACHINE_X64_UREM64, 12)
    X64_EXPANSION(MACHINE_X64_CALL_DIRECT, 13)
    X64_EXPANSION(MACHINE_X64_CALL_INDIRECT, 14)
    X64_EXPANSION(MACHINE_X64_LEA_TLS, 15)
    X64_EXPANSION(MACHINE_X64_SWITCH, 16)
    X64_EXPANSION(MACHINE_X64_COPY_FRAME_FROM_FRAME, 17)
    X64_EXPANSION(MACHINE_X64_COPY_FRAME_FROM_PTR, 18)
    X64_EXPANSION(MACHINE_X64_COPY_PTR_FROM_FRAME, 19)
    X64_EXPANSION(MACHINE_X64_STACK_ALLOCATE, 20)
    X64_EXPANSION(MACHINE_X64_ATOMIC_RMW, 21)
    X64_EXPANSION(MACHINE_X64_UD2, 22)
    X64_EXPANSION(MACHINE_X64_VA_SAVE, 23)
    X64_EXPANSION(MACHINE_X64_VA_ARG, 24)
    X64_EXPANSION(MACHINE_X64_ATOMIC_CMPXCHG16, 25)
#undef X64_EXPANSION
