...
typedef enum CSymbolWellKnown
{
    ...
    C_SYMBOL_WELL_KNOWN_ATTRIBUTE,
    C_SYMBOL_WELL_KNOWN_ATTRIBUTE_SHORT,
    C_SYMBOL_WELL_KNOWN_SIZEOF,
    C_SYMBOL_WELL_KNOWN_ALIGNOF,
    C_SYMBOL_WELL_KNOWN_ALIGNOF_GNU,
    C_SYMBOL_WELL_KNOWN_ALIGNOF_GNU_ALT,
    C_SYMBOL_WELL_KNOWN_THREAD_LOCAL_C23,
    C_SYMBOL_WELL_KNOWN_INLINE,
    C_SYMBOL_WELL_KNOWN_INLINE_GNU,
