...
enum
{
    ...
    BUSTER_X86_COMPLETION_CENSUS_EXPECTED_NORMALIZED_COUNT = 10636,
    BUSTER_X86_COMPLETION_CENSUS_EXPECTED_METADATA_EMITTED_COUNT = 10606,
    BUSTER_X86_COMPLETION_CENSUS_EXPECTED_METADATA_BLOCKED_COUNT = 30,
    BUSTER_X86_COMPLETION_CENSUS_EXPECTED_NON_NORMALIZED_COUNT = 377,
};
