...
BUSTER_CT_CHECK(TARGET_CPU_FEATURE_AARCH64_RDM == 132);
...
static TargetCpuFeatures const buster_a64_direct_simd_requirement_masks[BUSTER_A64_DIRECT_SIMD_REQUIREMENT_COUNT] = {
    ...
    [BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_RDM] = {{UINT64_C(1) << 10, 0, UINT64_C(1) << 3, 0}},
};
...
{
    BusterA64DirectSIMDGeneratedArrangementBinding const* result;
    ...
    {
        result = &buster_a64_direct_simd_generated_arrangement_bindings[row_index][operand_index];
    }
