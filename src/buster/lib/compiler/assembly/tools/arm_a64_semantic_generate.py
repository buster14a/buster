...
def main() -> int:
    ...
    manifest_obj = {
        ...
        "source": {"release": "2026-06", "tree_sha256": SOURCE_TREE_SHA256, "directory": args.source.name, "raw_source_policy": "raw Arm XML is not vendored; obtain the pinned release from Arm and verify this tree SHA-256 before regeneration"},
