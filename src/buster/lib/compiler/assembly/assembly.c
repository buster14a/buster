...
struct AssemblyInstructionInfo
{
    ...
    u32 aarch64_direct_simd_row_index;
    u32 aarch64_direct_simd_spelling_first;
    u8 aarch64_direct_simd_spelling_count;
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_control_condition_parse(String8 text, u64* value)
{
    ...
    {
        /* AArch64 spells conditions 2 and 3 as either CS/HS and CC/LO.  The
         * generated semantic table keeps one canonical name per encoding; accept
         * the architectural aliases at this shared textual boundary so control
         * instructions and direct-SIMD condition fields agree. */
        if (assembly_word_equal(text, S8("hs")))
        {
            *value = 2;
            return true;
        }
        if (assembly_word_equal(text, S8("lo")))
        {
            *value = 3;
            return true;
        }
...
{
    if (row && buster_aarch64_system_semantic_target_supported(target))
    {
...
{
    if (!result || !buster_aarch64_system_semantic_target_supported(target))
    {
        return false;
    }
    u32 row = UINT32_MAX;
    ...
    if (!assembly_aarch64_system_mnemonic_row(target, mnemonic, &row))
    {
        return false;
    }
    BusterAarch64SystemSemanticRecord metadata = {0};
...
BUSTER_GLOBAL_LOCAL AssemblyAmdForm const assembly_x86_amd_forms[] = {
    {.name = S8_INITIALIZER("vpermil2ps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_VEX_VECTOR5_IMMEDIATE, .operand_count = 5, .vector_width_mask = 3, .element_bytes = 4, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpermil2pd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_VEX_VECTOR5_IMMEDIATE, .operand_count = 5, .vector_width_mask = 3, .element_bytes = 8, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacssww"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacsswd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacssdql"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacsww"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacswd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacsdql"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcmov"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpperm"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmadcsswd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmadcswd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_IMMEDIATE, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 1, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_IMMEDIATE, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 2, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_IMMEDIATE, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 4, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_IMMEDIATE, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 8, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vprotq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacssdd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacssdqh"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacsdd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpmacsdqh"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR4_SELECT, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 1, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 2, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 4, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 8, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomub"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 1, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomuw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 2, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomud"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 4, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpcomuq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_COMPARE_IMMEDIATE, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 8, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vfrczps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 3, .element_bytes = 4, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vfrczpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 3, .element_bytes = 8, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vfrczss"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_SCALAR, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vfrczsd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_SCALAR, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshlb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshlw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshld"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshlq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddbw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddbd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddbq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddwd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddwq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddubw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddubd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddubq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphadduwd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphadduwq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphsubbw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphsubwd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphsubdq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshab"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshaw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshad"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vpshaq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR3_SHIFT, .operand_count = 3, .vector_width_mask = 1, .element_bytes = 0, .flags = ASSEMBLY_AMD_FORM_ALLOW_W1, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphadddq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("vphaddudq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_VECTOR2, .operand_count = 2, .vector_width_mask = 1, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_XOP},
    {.name = S8_INITIALIZER("llwpcb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_LWP1, .operand_count = 1, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_LWP},
    {.name = S8_INITIALIZER("slwpcb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_LWP1, .operand_count = 1, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_LWP},
    {.name = S8_INITIALIZER("lwpins"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_LWP3, .operand_count = 3, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_LWP},
    {.name = S8_INITIALIZER("lwpval"), .opcode = ASSEMBLY_OPCODE_X86_AMD_XOP, .encoding = ASSEMBLY_AMD_ENCODING_XOP_LWP3, .operand_count = 3, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_LWP},
    {.name = S8_INITIALIZER("vfmaddsubps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmaddsubpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmsubaddps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmsubaddpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmaddps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmaddpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmaddss"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmaddsd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmsubps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmsubpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmsubss"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfmsubsd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmaddps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmaddpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmaddss"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmaddsd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmsubps"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmsubpd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 3, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmsubss"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 4, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("vfnmsubsd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FMA4, .encoding = ASSEMBLY_AMD_ENCODING_VEX_FMA4, .operand_count = 4, .vector_width_mask = 1, .element_bytes = 8, .flags = ASSEMBLY_AMD_FORM_SCALAR | ASSEMBLY_AMD_FORM_DEFAULT_W1, .feature = TARGET_CPU_FEATURE_X86_FMA4},
    {.name = S8_INITIALIZER("bextr"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR3_BEXTR, .operand_count = 3, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blcfill"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blci"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blcic"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blcmsk"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blcs"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blsfill"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("blsic"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("t1mskc"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("tzmsk"), .opcode = ASSEMBLY_OPCODE_X86_AMD_TBM, .encoding = ASSEMBLY_AMD_ENCODING_XOP_GPR2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_TBM},
    {.name = S8_INITIALIZER("femms"), .opcode = ASSEMBLY_OPCODE_X86_AMD_FEMMS, .encoding = ASSEMBLY_AMD_ENCODING_FEMMS, .operand_count = 0, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pi2fw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOWA},
    {.name = S8_INITIALIZER("pi2fd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pf2iw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOWA},
    {.name = S8_INITIALIZER("pf2id"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfnacc"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOWA},
    {.name = S8_INITIALIZER("pfpnacc"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOWA},
    {.name = S8_INITIALIZER("pfcmpge"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfmin"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfrcp"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfrsqrt"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfsub"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfadd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfcmpgt"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfmax"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfrcpit1"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfrsqit1"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfsubr"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfacc"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfcmpeq"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfmul"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pfrcpit2"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pmulhrw"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
    {.name = S8_INITIALIZER("pswapd"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOWA},
    {.name = S8_INITIALIZER("pavgusb"), .opcode = ASSEMBLY_OPCODE_X86_AMD_3DNOW, .encoding = ASSEMBLY_AMD_ENCODING_3DNOW2, .operand_count = 2, .vector_width_mask = 0, .element_bytes = 0, .flags = 0, .feature = TARGET_CPU_FEATURE_X86_3DNOW},
};
...
BUSTER_GLOBAL_LOCAL AssemblyAarch64DirectSIMDSpelling const assembly_aarch64_direct_simd_spellings[] = {
    ...
    {S8_INITIALIZER("abs"), UINT64_C(0xfea2e56971759532), S8_INITIALIZER("arm-a64@2026-06:ABS_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    ...
    {S8_INITIALIZER("neg"), UINT64_C(0x6f2db5cd0e80e8df), S8_INITIALIZER("arm-a64@2026-06:NEG_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("neg"), UINT64_C(0x2ecfb0df2a6f90aa), S8_INITIALIZER("arm-a64@2026-06:NEG_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqabs"), UINT64_C(0x1e0368865d6eb3a), S8_INITIALIZER("arm-a64@2026-06:SQABS_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqabs"), UINT64_C(0x660ca7bdaac17cb2), S8_INITIALIZER("arm-a64@2026-06:SQABS_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqneg"), UINT64_C(0x4e67ba58c5625519), S8_INITIALIZER("arm-a64@2026-06:SQNEG_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqneg"), UINT64_C(0x9bf194cfa4c92757), S8_INITIALIZER("arm-a64@2026-06:SQNEG_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("suqadd"), UINT64_C(0x84b681f778c42b07), S8_INITIALIZER("arm-a64@2026-06:SUQADD_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("suqadd"), UINT64_C(0x7e96fdf6e945102a), S8_INITIALIZER("arm-a64@2026-06:SUQADD_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("usqadd"), UINT64_C(0x89f1219b62f3c332), S8_INITIALIZER("arm-a64@2026-06:USQADD_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("usqadd"), UINT64_C(0xb5cc5f5476fff9cb), S8_INITIALIZER("arm-a64@2026-06:USQADD_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fabs"), UINT64_C(0x36f968f48051514a), S8_INITIALIZER("arm-a64@2026-06:FABS_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fabs"), UINT64_C(0x4a4040d9c77df4e6), S8_INITIALIZER("arm-a64@2026-06:FABS_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fabs"), UINT64_C(0x39e725dee11116b4), S8_INITIALIZER("arm-a64@2026-06:FABS_D_floatdp1"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("fabs"), UINT64_C(0x45758f3e89ff2d7c), S8_INITIALIZER("arm-a64@2026-06:FABS_H_floatdp1"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H}},
    {S8_INITIALIZER("fabs"), UINT64_C(0xf59a9698b7dd189a), S8_INITIALIZER("arm-a64@2026-06:FABS_S_floatdp1"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S}},
   {S8_INITIALIZER("fcvtas"), UINT64_C(0x4f0d4aa444a703c3), S8_INITIALIZER("arm-a64@2026-06:FCVTAS_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtas"), UINT64_C(0xb136a8c538688714), S8_INITIALIZER("arm-a64@2026-06:FCVTAS_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtas"), UINT64_C(0xd33905a6110a18df), S8_INITIALIZER("arm-a64@2026-06:FCVTAS_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtau"), UINT64_C(0xb619bd066b0e781c), S8_INITIALIZER("arm-a64@2026-06:FCVTAU_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtau"), UINT64_C(0xbd26a7e9e85cefab), S8_INITIALIZER("arm-a64@2026-06:FCVTAU_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtms"), UINT64_C(0x7fac83040ecaea0), S8_INITIALIZER("arm-a64@2026-06:FCVTMS_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtms"), UINT64_C(0x3218cf33b9dd8b1a), S8_INITIALIZER("arm-a64@2026-06:FCVTMS_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtmu"), UINT64_C(0x9b8dcd4d4c67f572), S8_INITIALIZER("arm-a64@2026-06:FCVTMU_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtmu"), UINT64_C(0xba3b6d125a310c48), S8_INITIALIZER("arm-a64@2026-06:FCVTMU_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtns"), UINT64_C(0xb209c6c5774ff80a), S8_INITIALIZER("arm-a64@2026-06:FCVTNS_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtns"), UINT64_C(0x7fcee0c14317c554), S8_INITIALIZER("arm-a64@2026-06:FCVTNS_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtnu"), UINT64_C(0xe4f9a16c98f48e48), S8_INITIALIZER("arm-a64@2026-06:FCVTNU_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtnu"), UINT64_C(0xe01aa9b9b96b7005), S8_INITIALIZER("arm-a64@2026-06:FCVTNU_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtps"), UINT64_C(0x3b232c20144a7a63), S8_INITIALIZER("arm-a64@2026-06:FCVTPS_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtps"), UINT64_C(0x25cadafa07a55199), S8_INITIALIZER("arm-a64@2026-06:FCVTPS_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtpu"), UINT64_C(0xced186bb58e64235), S8_INITIALIZER("arm-a64@2026-06:FCVTPU_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtpu"), UINT64_C(0x248924da93c591b0), S8_INITIALIZER("arm-a64@2026-06:FCVTPU_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    ...
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzs"), UINT64_C(0x7f64b5f5a04de3cf), S8_INITIALIZER("arm-a64@2026-06:FCVTZS_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzs"), UINT64_C(0x825ae0de120e1dc4), S8_INITIALIZER("arm-a64@2026-06:FCVTZS_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzs"), UINT64_C(0x3b2e1ec87178fbdc), S8_INITIALIZER("arm-a64@2026-06:FCVTZS_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzu"), UINT64_C(0x179616cd50c5f96c), S8_INITIALIZER("arm-a64@2026-06:FCVTZU_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzu"), UINT64_C(0x93592f920a7f5cb8), S8_INITIALIZER("arm-a64@2026-06:FCVTZU_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzu"), UINT64_C(0xa919d8c00e6398fb), S8_INITIALIZER("arm-a64@2026-06:FCVTZU_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcvtzu"), UINT64_C(0xf219ada0644460b4), S8_INITIALIZER("arm-a64@2026-06:FCVTZU_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fneg"), UINT64_C(0x7c47809c17721785), S8_INITIALIZER("arm-a64@2026-06:FNEG_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fneg"), UINT64_C(0x70d53a80b294b29d), S8_INITIALIZER("arm-a64@2026-06:FNEG_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frecpe"), UINT64_C(0x8b1d46d53534e1fe), S8_INITIALIZER("arm-a64@2026-06:FRECPE_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecpe"), UINT64_C(0x374ec904f3062ae6), S8_INITIALIZER("arm-a64@2026-06:FRECPE_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecpe"), UINT64_C(0x366d8fabc5069f22), S8_INITIALIZER("arm-a64@2026-06:FRECPE_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecpe"), UINT64_C(0xffc3781afb276d9c), S8_INITIALIZER("arm-a64@2026-06:FRECPE_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frint32x"), UINT64_C(0x418e0ab118cb28ba), S8_INITIALIZER("arm-a64@2026-06:FRINT32X_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FPTOINT,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frint32z"), UINT64_C(0x8dede1d564313c59), S8_INITIALIZER("arm-a64@2026-06:FRINT32Z_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FPTOINT,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frint64x"), UINT64_C(0x956ff9b673405173), S8_INITIALIZER("arm-a64@2026-06:FRINT64X_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FPTOINT,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frint64z"), UINT64_C(0x89795480cfdf8cbf), S8_INITIALIZER("arm-a64@2026-06:FRINT64Z_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FPTOINT,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frinta"), UINT64_C(0xd48a38e1f599a8ee), S8_INITIALIZER("arm-a64@2026-06:FRINTA_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frinta"), UINT64_C(0x998c3ba836d019ad), S8_INITIALIZER("arm-a64@2026-06:FRINTA_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frinti"), UINT64_C(0xe5f3251e48a70096), S8_INITIALIZER("arm-a64@2026-06:FRINTI_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frinti"), UINT64_C(0x5cd7cb8b6a8bc14f), S8_INITIALIZER("arm-a64@2026-06:FRINTI_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frintm"), UINT64_C(0x3bf81ea4d008a284), S8_INITIALIZER("arm-a64@2026-06:FRINTM_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frintm"), UINT64_C(0x71761da42f61fc7d), S8_INITIALIZER("arm-a64@2026-06:FRINTM_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frintn"), UINT64_C(0x40032043f93745e1), S8_INITIALIZER("arm-a64@2026-06:FRINTN_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frintn"), UINT64_C(0x8400e2d2506998f3), S8_INITIALIZER("arm-a64@2026-06:FRINTN_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frintp"), UINT64_C(0x28f5938a3a2d53bc), S8_INITIALIZER("arm-a64@2026-06:FRINTP_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frintp"), UINT64_C(0x6a3f308b38e353fd), S8_INITIALIZER("arm-a64@2026-06:FRINTP_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frintx"), UINT64_C(0x9f66931cf6d997e6), S8_INITIALIZER("arm-a64@2026-06:FRINTX_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frintx"), UINT64_C(0x11f79f67515d515e), S8_INITIALIZER("arm-a64@2026-06:FRINTX_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frintz"), UINT64_C(0x6a39a1e2e0ce2ac), S8_INITIALIZER("arm-a64@2026-06:FRINTZ_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frintz"), UINT64_C(0x18e04695e73b015b), S8_INITIALIZER("arm-a64@2026-06:FRINTZ_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frsqrte"), UINT64_C(0x7d706c36b4a336c5), S8_INITIALIZER("arm-a64@2026-06:FRSQRTE_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frsqrte"), UINT64_C(0xa8946616cf3a7d68), S8_INITIALIZER("arm-a64@2026-06:FRSQRTE_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frsqrte"), UINT64_C(0xd187ef754b422465), S8_INITIALIZER("arm-a64@2026-06:FRSQRTE_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frsqrte"), UINT64_C(0x1c1e583fb0130ded), S8_INITIALIZER("arm-a64@2026-06:FRSQRTE_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fsqrt"), UINT64_C(0x18e5419a44ba4bc6), S8_INITIALIZER("arm-a64@2026-06:FSQRT_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fsqrt"), UINT64_C(0xcf0fa69ade73f29b), S8_INITIALIZER("arm-a64@2026-06:FSQRT_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("scvtf"), UINT64_C(0x8a77ea4691e7f089), S8_INITIALIZER("arm-a64@2026-06:SCVTF_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("scvtf"), UINT64_C(0x8fbf3a3a185ff928), S8_INITIALIZER("arm-a64@2026-06:SCVTF_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("scvtf"), UINT64_C(0x64b916004f70de18), S8_INITIALIZER("arm-a64@2026-06:SCVTF_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("scvtf"), UINT64_C(0x6d3cba1f48df4b78), S8_INITIALIZER("arm-a64@2026-06:SCVTF_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("ucvtf"), UINT64_C(0xa058985515bdf85f), S8_INITIALIZER("arm-a64@2026-06:UCVTF_asimdmisc_R"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("ucvtf"), UINT64_C(0x8a8e6b7c5213fb44), S8_INITIALIZER("arm-a64@2026-06:UCVTF_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("ucvtf"), UINT64_C(0x936bee54d99e33c6), S8_INITIALIZER("arm-a64@2026-06:UCVTF_asimdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("ucvtf"), UINT64_C(0xfa9f851b4423665f), S8_INITIALIZER("arm-a64@2026-06:UCVTF_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fabd"), UINT64_C(0x3aaa3148c5355eb8), S8_INITIALIZER("arm-a64@2026-06:FABD_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fabd"), UINT64_C(0xeccb3d01478f107a), S8_INITIALIZER("arm-a64@2026-06:FABD_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fabd"), UINT64_C(0x8459dce91a7b0745), S8_INITIALIZER("arm-a64@2026-06:FABD_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fabd"), UINT64_C(0x2cdab270dc0ab4a2), S8_INITIALIZER("arm-a64@2026-06:FABD_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("facge"), UINT64_C(0x4f2647a83e1148e2), S8_INITIALIZER("arm-a64@2026-06:FACGE_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("facge"), UINT64_C(0x7dfd30a750682261), S8_INITIALIZER("arm-a64@2026-06:FACGE_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("facge"), UINT64_C(0x867bd108f2152b89), S8_INITIALIZER("arm-a64@2026-06:FACGE_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("facge"), UINT64_C(0x5b5c70d9b7166913), S8_INITIALIZER("arm-a64@2026-06:FACGE_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("facgt"), UINT64_C(0x19ad4ce0297dd364), S8_INITIALIZER("arm-a64@2026-06:FACGT_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("facgt"), UINT64_C(0x1c3144f7e9fc3d66), S8_INITIALIZER("arm-a64@2026-06:FACGT_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("facgt"), UINT64_C(0xb492e8579be4e6c5), S8_INITIALIZER("arm-a64@2026-06:FACGT_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("facgt"), UINT64_C(0x7c16f71cfba82dd1), S8_INITIALIZER("arm-a64@2026-06:FACGT_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("faddp"), UINT64_C(0xef5ccee40ed3b7a9), S8_INITIALIZER("arm-a64@2026-06:FADDP_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("faddp"), UINT64_C(0xe8ad7e0069b990e6), S8_INITIALIZER("arm-a64@2026-06:FADDP_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("faddp"), UINT64_C(0x8b9efc88b9785f10), S8_INITIALIZER("arm-a64@2026-06:FADDP_asisdpair_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("faddp"), UINT64_C(0xc08216e60faa00f1), S8_INITIALIZER("arm-a64@2026-06:FADDP_asisdpair_only_SD"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fadd"), UINT64_C(0xc9074ffe725f66e2), S8_INITIALIZER("arm-a64@2026-06:FADD_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fadd"), UINT64_C(0x2129a5001b94b178), S8_INITIALIZER("arm-a64@2026-06:FADD_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fadd"), UINT64_C(0x24fe9bae9c51ccd5), S8_INITIALIZER("arm-a64@2026-06:FADD_D_floatdp2"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("fadd"), UINT64_C(0xfd3ed77c6e43d89d), S8_INITIALIZER("arm-a64@2026-06:FADD_H_floatdp2"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H}},
    {S8_INITIALIZER("fadd"), UINT64_C(0xacf2c43a6428088e), S8_INITIALIZER("arm-a64@2026-06:FADD_S_floatdp2"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S}},
    {S8_INITIALIZER("fcmp"), UINT64_C(0xc980d99c3ea0fd5b), S8_INITIALIZER("arm-a64@2026-06:FCMP_D_floatcmp"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("fcmp"), UINT64_C(0x88b52875afab530c), S8_INITIALIZER("arm-a64@2026-06:FCMP_H_floatcmp"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H}},
    {S8_INITIALIZER("fcmp"), UINT64_C(0x806ab6babb1e173b), S8_INITIALIZER("arm-a64@2026-06:FCMP_S_floatcmp"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S}},
    {S8_INITIALIZER("fcmpe"), UINT64_C(0x619a154570b3b61a), S8_INITIALIZER("arm-a64@2026-06:FCMPE_D_floatcmp"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("fcmpe"), UINT64_C(0x4fc3e86312b40b5a), S8_INITIALIZER("arm-a64@2026-06:FCMPE_H_floatcmp"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H}},
    {S8_INITIALIZER("fcmpe"), UINT64_C(0x713b8bd2f7c3198f), S8_INITIALIZER("arm-a64@2026-06:FCMPE_S_floatcmp"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S}},
    {S8_INITIALIZER("fcsel"), UINT64_C(0x334422a1dbe54a6a), S8_INITIALIZER("arm-a64@2026-06:FCSEL_D_floatsel"), 4,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcsel"), UINT64_C(0x942ac11ca7582058), S8_INITIALIZER("arm-a64@2026-06:FCSEL_H_floatsel"), 4,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcsel"), UINT64_C(0x39955c862311f855), S8_INITIALIZER("arm-a64@2026-06:FCSEL_S_floatsel"), 4,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_FP,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fcmeq"), UINT64_C(0x8dd7fb0e6e2d0e90), S8_INITIALIZER("arm-a64@2026-06:FCMEQ_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmeq"), UINT64_C(0x928c0820e962783c), S8_INITIALIZER("arm-a64@2026-06:FCMEQ_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmeq"), UINT64_C(0xa717cf4ad6ae012f), S8_INITIALIZER("arm-a64@2026-06:FCMEQ_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmeq"), UINT64_C(0xbc6537df310541d3), S8_INITIALIZER("arm-a64@2026-06:FCMEQ_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fcmge"), UINT64_C(0x3d5884765339045f), S8_INITIALIZER("arm-a64@2026-06:FCMGE_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmge"), UINT64_C(0x947d5d7aedb1f102), S8_INITIALIZER("arm-a64@2026-06:FCMGE_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmge"), UINT64_C(0x1a7a6e28137b76cd), S8_INITIALIZER("arm-a64@2026-06:FCMGE_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmge"), UINT64_C(0xa4523fd8a661e9c3), S8_INITIALIZER("arm-a64@2026-06:FCMGE_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fcmgt"), UINT64_C(0x1046056aa1eb048e), S8_INITIALIZER("arm-a64@2026-06:FCMGT_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmgt"), UINT64_C(0xe27fd863ab16906f), S8_INITIALIZER("arm-a64@2026-06:FCMGT_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmgt"), UINT64_C(0x176d7f8bff8af329), S8_INITIALIZER("arm-a64@2026-06:FCMGT_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fcmgt"), UINT64_C(0xcd717cac1550eac6), S8_INITIALIZER("arm-a64@2026-06:FCMGT_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fdiv"), UINT64_C(0xd58ce4db7021007b), S8_INITIALIZER("arm-a64@2026-06:FDIV_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fdiv"), UINT64_C(0xfbeb22d5f375f8f7), S8_INITIALIZER("arm-a64@2026-06:FDIV_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmaxnmp"), UINT64_C(0xaa8ad07d6b1a44df), S8_INITIALIZER("arm-a64@2026-06:FMAXNMP_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxnmp"), UINT64_C(0x9a12fcb3977ce62), S8_INITIALIZER("arm-a64@2026-06:FMAXNMP_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxnmp"), UINT64_C(0x5bbbd15e32be1737), S8_INITIALIZER("arm-a64@2026-06:FMAXNMP_asisdpair_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxnmp"), UINT64_C(0x0e7a94c880401404), S8_INITIALIZER("arm-a64@2026-06:FMAXNMP_asisdpair_only_SD"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmaxnm"), UINT64_C(0x032995800a2aa37c), S8_INITIALIZER("arm-a64@2026-06:FMAXNM_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxnm"), UINT64_C(0x7b4c9bac157b5dcd), S8_INITIALIZER("arm-a64@2026-06:FMAXNM_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmaxp"), UINT64_C(0x32e4c02aa4111d01), S8_INITIALIZER("arm-a64@2026-06:FMAXP_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxp"), UINT64_C(0x813457895f7ce0d7), S8_INITIALIZER("arm-a64@2026-06:FMAXP_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxp"), UINT64_C(0x4625fcdc5f7b28f4), S8_INITIALIZER("arm-a64@2026-06:FMAXP_asisdpair_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmaxp"), UINT64_C(0xc4f84bdaed7c70c8), S8_INITIALIZER("arm-a64@2026-06:FMAXP_asisdpair_only_SD"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmax"), UINT64_C(0x5c9a075a71ddf8e2), S8_INITIALIZER("arm-a64@2026-06:FMAX_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmax"), UINT64_C(0xfaedf05cf068bf28), S8_INITIALIZER("arm-a64@2026-06:FMAX_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fminnmp"), UINT64_C(0xfd2d346edbeea54e), S8_INITIALIZER("arm-a64@2026-06:FMINNMP_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminnmp"), UINT64_C(0xe80336897c9a357b), S8_INITIALIZER("arm-a64@2026-06:FMINNMP_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminnmp"), UINT64_C(0x25afbf2d1bc84bca), S8_INITIALIZER("arm-a64@2026-06:FMINNMP_asisdpair_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminnmp"), UINT64_C(0xe914f361850bc373), S8_INITIALIZER("arm-a64@2026-06:FMINNMP_asisdpair_only_SD"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fminnm"), UINT64_C(0xda4ddf33c1ba749c), S8_INITIALIZER("arm-a64@2026-06:FMINNM_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminnm"), UINT64_C(0x995312a626c3649d), S8_INITIALIZER("arm-a64@2026-06:FMINNM_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fminp"), UINT64_C(0x4cd117eb363e2c78), S8_INITIALIZER("arm-a64@2026-06:FMINP_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminp"), UINT64_C(0xbd6d714d8112f81c), S8_INITIALIZER("arm-a64@2026-06:FMINP_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminp"), UINT64_C(0x97d575f7b14405de), S8_INITIALIZER("arm-a64@2026-06:FMINP_asisdpair_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fminp"), UINT64_C(0x82de85dfb92fb794), S8_INITIALIZER("arm-a64@2026-06:FMINP_asisdpair_only_SD"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmin"), UINT64_C(0x4056d40a70119de7), S8_INITIALIZER("arm-a64@2026-06:FMIN_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmin"), UINT64_C(0x302b657ec3312835), S8_INITIALIZER("arm-a64@2026-06:FMIN_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmla"), UINT64_C(0x030d357ec711cb60), S8_INITIALIZER("arm-a64@2026-06:FMLA_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmla"), UINT64_C(0x7508cce16fcae6ee), S8_INITIALIZER("arm-a64@2026-06:FMLA_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmlal2"), UINT64_C(0x7cd436e3f3d6fb58), S8_INITIALIZER("arm-a64@2026-06:FMLAL2_asimdsame_F"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FP16FML,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmlal"), UINT64_C(0x424770611f6d4571), S8_INITIALIZER("arm-a64@2026-06:FMLAL_asimdsame_F"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FP16FML,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmlsl2"), UINT64_C(0x3a930821d594548d), S8_INITIALIZER("arm-a64@2026-06:FMLSL2_asimdsame_F"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FP16FML,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmlsl"), UINT64_C(0x7c64660496445a9d), S8_INITIALIZER("arm-a64@2026-06:FMLSL_asimdsame_F"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FP16FML,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmls"), UINT64_C(0x6e7257ac7fc0f865), S8_INITIALIZER("arm-a64@2026-06:FMLS_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmls"), UINT64_C(0xc58e155ad85cea11), S8_INITIALIZER("arm-a64@2026-06:FMLS_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmulx"), UINT64_C(0xe14549b23ddf379a), S8_INITIALIZER("arm-a64@2026-06:FMULX_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmulx"), UINT64_C(0x60d5d68fc850b2b6), S8_INITIALIZER("arm-a64@2026-06:FMULX_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmulx"), UINT64_C(0x7ff0b8514e7d3c1f), S8_INITIALIZER("arm-a64@2026-06:FMULX_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmulx"), UINT64_C(0x895575d4b935c180), S8_INITIALIZER("arm-a64@2026-06:FMULX_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmul"), UINT64_C(0x25d9ffffdd7ad3f9), S8_INITIALIZER("arm-a64@2026-06:FMUL_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fmul"), UINT64_C(0xf4732ebe28fd191a), S8_INITIALIZER("arm-a64@2026-06:FMUL_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frecps"), UINT64_C(0x1cb2a8b2ae0d2f70), S8_INITIALIZER("arm-a64@2026-06:FRECPS_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecps"), UINT64_C(0x3110ab89b094849e), S8_INITIALIZER("arm-a64@2026-06:FRECPS_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecps"), UINT64_C(0x170d5536e6987b00), S8_INITIALIZER("arm-a64@2026-06:FRECPS_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecps"), UINT64_C(0xb1e49304d1f0d40e), S8_INITIALIZER("arm-a64@2026-06:FRECPS_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("frsqrts"), UINT64_C(0x13b28e427f1a5244), S8_INITIALIZER("arm-a64@2026-06:FRSQRTS_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frsqrts"), UINT64_C(0x516f45fa0fa4ea2e), S8_INITIALIZER("arm-a64@2026-06:FRSQRTS_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frsqrts"), UINT64_C(0xe3de087e1013a456), S8_INITIALIZER("arm-a64@2026-06:FRSQRTS_asisdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frsqrts"), UINT64_C(0x992ba276d9a1e1c1), S8_INITIALIZER("arm-a64@2026-06:FRSQRTS_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fsub"), UINT64_C(0x9ac4a4e9274ed9d4), S8_INITIALIZER("arm-a64@2026-06:FSUB_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("fsub"), UINT64_C(0x113061a7dd458da8), S8_INITIALIZER("arm-a64@2026-06:FSUB_asimdsamefp16_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("addp"), UINT64_C(0xabb728ab3eaf08aa), S8_INITIALIZER("arm-a64@2026-06:ADDP_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("addp"), UINT64_C(0x98b8e2d558091216), S8_INITIALIZER("arm-a64@2026-06:ADDP_asisdpair_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D}},
    {S8_INITIALIZER("rev64"), UINT64_C(0x6c9ec232f3f8bb00), S8_INITIALIZER("arm-a64@2026-06:REV64_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("urecpe"), UINT64_C(0xc780556f4e2be721), S8_INITIALIZER("arm-a64@2026-06:URECPE_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("ursqrte"), UINT64_C(0x96a3cec81c08ba35), S8_INITIALIZER("arm-a64@2026-06:URSQRTE_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmeq"), UINT64_C(0x4bcb414feaab1fcd), S8_INITIALIZER("arm-a64@2026-06:CMEQ_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmeq"), UINT64_C(0xf0069bc3f3d78400), S8_INITIALIZER("arm-a64@2026-06:CMEQ_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("cmge"), UINT64_C(0x25ce34475d72334d), S8_INITIALIZER("arm-a64@2026-06:CMGE_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmge"), UINT64_C(0x6eacba4e96135495), S8_INITIALIZER("arm-a64@2026-06:CMGE_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("cmgt"), UINT64_C(0xadc2e6aa5173fc0), S8_INITIALIZER("arm-a64@2026-06:CMGT_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmgt"), UINT64_C(0x92e7ff05957ea047), S8_INITIALIZER("arm-a64@2026-06:CMGT_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("cmhi"), UINT64_C(0x87794c35ce3a68d0), S8_INITIALIZER("arm-a64@2026-06:CMHI_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmhi"), UINT64_C(0xaa949f7d1f29089a), S8_INITIALIZER("arm-a64@2026-06:CMHI_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("cmhs"), UINT64_C(0x3bb8226d654e604d), S8_INITIALIZER("arm-a64@2026-06:CMHS_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmhs"), UINT64_C(0xab6a959d4a8cbef3), S8_INITIALIZER("arm-a64@2026-06:CMHS_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("cmtst"), UINT64_C(0xe637c1caae107056), S8_INITIALIZER("arm-a64@2026-06:CMTST_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("cmtst"), UINT64_C(0x4a1317795dfc29c9), S8_INITIALIZER("arm-a64@2026-06:CMTST_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("fcvtxn"), UINT64_C(0xbbe797249dd7b649), S8_INITIALIZER("arm-a64@2026-06:FCVTXN_asisdmisc_N"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
   {S8_INITIALIZER("fmaxnmv"), UINT64_C(0xd828dd77e54a4811), S8_INITIALIZER("arm-a64@2026-06:FMAXNMV_asimdall_only_SD"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("fmaxnmv"), UINT64_C(0xb3cb9d859362f633), S8_INITIALIZER("arm-a64@2026-06:FMAXNMV_asimdall_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fmaxv"), UINT64_C(0xef5540e4a2cff8aa), S8_INITIALIZER("arm-a64@2026-06:FMAXV_asimdall_only_SD"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("fmaxv"), UINT64_C(0x21b9304dfa220ddd), S8_INITIALIZER("arm-a64@2026-06:FMAXV_asimdall_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fminnmv"), UINT64_C(0xd548a439440da4), S8_INITIALIZER("arm-a64@2026-06:FMINNMV_asimdall_only_SD"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("fminnmv"), UINT64_C(0x5b53da56a57e00d1), S8_INITIALIZER("arm-a64@2026-06:FMINNMV_asimdall_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("fminv"), UINT64_C(0x09c8ee383cb4fa15), S8_INITIALIZER("arm-a64@2026-06:FMINV_asimdall_only_SD"), 2,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("fminv"), UINT64_C(0xde29ff8b23c707f9), S8_INITIALIZER("arm-a64@2026-06:FMINV_asimdall_only_H"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("srshl"), UINT64_C(0x786f9a5f46bfbded), S8_INITIALIZER("arm-a64@2026-06:SRSHL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("srshl"), UINT64_C(0xa6d21f66dfad9d87), S8_INITIALIZER("arm-a64@2026-06:SRSHL_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("sshl"), UINT64_C(0x1357836e8376cb69), S8_INITIALIZER("arm-a64@2026-06:SSHL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sshl"), UINT64_C(0x45fc861e6aaa921f), S8_INITIALIZER("arm-a64@2026-06:SSHL_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("urshl"), UINT64_C(0x639d8d3a8e981983), S8_INITIALIZER("arm-a64@2026-06:URSHL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("urshl"), UINT64_C(0xdb7da3f6ffe90b86), S8_INITIALIZER("arm-a64@2026-06:URSHL_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("ushl"), UINT64_C(0x679d133d69c5b677), S8_INITIALIZER("arm-a64@2026-06:USHL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("ushl"), UINT64_C(0x21a8b95b0103cf0e), S8_INITIALIZER("arm-a64@2026-06:USHL_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D}},
    {S8_INITIALIZER("aesd"), UINT64_C(0x6cacc320d32f7696), S8_INITIALIZER("arm-a64@2026-06:AESD_B_cryptoaes"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_AES, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B}},
    {S8_INITIALIZER("aese"), UINT64_C(0x64d13665bc040990), S8_INITIALIZER("arm-a64@2026-06:AESE_B_cryptoaes"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_AES, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B}},
    {S8_INITIALIZER("aesimc"), UINT64_C(0xafd75da1d5d14815), S8_INITIALIZER("arm-a64@2026-06:AESIMC_B_cryptoaes"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_AES, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B}},
    {S8_INITIALIZER("aesmc"), UINT64_C(0x6a644c32fd7849e2), S8_INITIALIZER("arm-a64@2026-06:AESMC_B_cryptoaes"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_AES, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B}},
    {S8_INITIALIZER("bcax"), UINT64_C(0xfab88050fa075b6f), S8_INITIALIZER("arm-a64@2026-06:BCAX_VVV16_crypto4"), 4,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B,
                                       BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B}},
    {S8_INITIALIZER("eor3"), UINT64_C(0x9a2c72cc6e6d8045), S8_INITIALIZER("arm-a64@2026-06:EOR3_VVV16_crypto4"), 4,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B,
                                       BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_16B}},
    {S8_INITIALIZER("rax1"), UINT64_C(0xd81c13f95e34182a), S8_INITIALIZER("arm-a64@2026-06:RAX1_VVV2_cryptosha512_3"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3, {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D,
                                       BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D}},
    {S8_INITIALIZER("sha512su0"), UINT64_C(0xe6d957574d81e0ab),
     S8_INITIALIZER("arm-a64@2026-06:SHA512SU0_VV2_cryptosha512_2"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D}},
    {S8_INITIALIZER("sha512su1"), UINT64_C(0xf5ea9d105f875216),
     S8_INITIALIZER("arm-a64@2026-06:SHA512SU1_VVV2_cryptosha512_3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D}},
    {S8_INITIALIZER("sha512h"), UINT64_C(0xb2b7deeed318433f),
     S8_INITIALIZER("arm-a64@2026-06:SHA512H_QQV_cryptosha512_3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D}},
    {S8_INITIALIZER("sha512h2"), UINT64_C(0xe2ea4e3019bc6fa6),
     S8_INITIALIZER("arm-a64@2026-06:SHA512H2_QQV_cryptosha512_3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA3,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_2D}},
    {S8_INITIALIZER("sha1c"), UINT64_C(0xc8bf61c1fbc4c68b),
     S8_INITIALIZER("arm-a64@2026-06:SHA1C_QSV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha1h"), UINT64_C(0x527117bcf01c589e),
     S8_INITIALIZER("arm-a64@2026-06:SHA1H_SS_cryptosha2"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S}},
    {S8_INITIALIZER("sha1m"), UINT64_C(0xfe21fb23ee0af9be),
     S8_INITIALIZER("arm-a64@2026-06:SHA1M_QSV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha1p"), UINT64_C(0x6df8cac602cb80f6),
     S8_INITIALIZER("arm-a64@2026-06:SHA1P_QSV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha1su0"), UINT64_C(0xe03e17b03ab0e566),
     S8_INITIALIZER("arm-a64@2026-06:SHA1SU0_VVV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha1su1"), UINT64_C(0x91788958671acea8),
     S8_INITIALIZER("arm-a64@2026-06:SHA1SU1_VV_cryptosha2"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha256su0"), UINT64_C(0x24d8b3ad23b8860c),
     S8_INITIALIZER("arm-a64@2026-06:SHA256SU0_VV_cryptosha2"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha256su1"), UINT64_C(0xd1c2681e9bf85abd),
     S8_INITIALIZER("arm-a64@2026-06:SHA256SU1_VVV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha256h"), UINT64_C(0x4d874cec7b60b7a5),
     S8_INITIALIZER("arm-a64@2026-06:SHA256H_QQV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("sha256h2"), UINT64_C(0x470540cee6a27190),
     S8_INITIALIZER("arm-a64@2026-06:SHA256H2_QQV_cryptosha3"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_SHA2,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_Q,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_4S}},
    {S8_INITIALIZER("shadd"), UINT64_C(0x56a53606b665014e),
     S8_INITIALIZER("arm-a64@2026-06:SHADD_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("shsub"), UINT64_C(0x39c9b1410b025abb),
     S8_INITIALIZER("arm-a64@2026-06:SHSUB_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqadd"), UINT64_C(0x29c051de1594276),
     S8_INITIALIZER("arm-a64@2026-06:SQADD_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqadd"), UINT64_C(0x1a9c9e4a34277770),
     S8_INITIALIZER("arm-a64@2026-06:SQADD_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqsub"), UINT64_C(0x2380f016e7cfa4b6),
     S8_INITIALIZER("arm-a64@2026-06:SQSUB_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqsub"), UINT64_C(0xc6f9093527fd096b),
     S8_INITIALIZER("arm-a64@2026-06:SQSUB_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqdmlal"), UINT64_C(0xa880474b2d693e03),
     S8_INITIALIZER("arm-a64@2026-06:SQDMLAL_asisddiff_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqdmlsl"), UINT64_C(0xf39ad3663eebb936),
     S8_INITIALIZER("arm-a64@2026-06:SQDMLSL_asisddiff_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqdmull"), UINT64_C(0x5eaf349cfe4c58fa),
     S8_INITIALIZER("arm-a64@2026-06:SQDMULL_asisddiff_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqxtn"), UINT64_C(0xaba6357972b5fd03),
     S8_INITIALIZER("arm-a64@2026-06:SQXTN_asisdmisc_N"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqxtun"), UINT64_C(0x947ecbd12b6c0cf8),
     S8_INITIALIZER("arm-a64@2026-06:SQXTUN_asisdmisc_N"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqadd"), UINT64_C(0x96647d47d1a1270f),
     S8_INITIALIZER("arm-a64@2026-06:UQADD_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqadd"), UINT64_C(0xad945432490cc5ce),
     S8_INITIALIZER("arm-a64@2026-06:UQADD_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqsub"), UINT64_C(0xbbc800b133a7127e),
     S8_INITIALIZER("arm-a64@2026-06:UQSUB_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqsub"), UINT64_C(0xe3c397989fe6f97),
     S8_INITIALIZER("arm-a64@2026-06:UQSUB_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqxtn"), UINT64_C(0xe02de395147ccab2),
     S8_INITIALIZER("arm-a64@2026-06:UQXTN_asisdmisc_N"), 2, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrshl"), UINT64_C(0x47afcf98abce1c03),
     S8_INITIALIZER("arm-a64@2026-06:SQRSHL_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrshl"), UINT64_C(0x750b011252e13008),
     S8_INITIALIZER("arm-a64@2026-06:SQRSHL_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqshl"), UINT64_C(0x45c2d983039f5b3d),
     S8_INITIALIZER("arm-a64@2026-06:SQSHL_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqshl"), UINT64_C(0x5516341c51784243),
     S8_INITIALIZER("arm-a64@2026-06:SQSHL_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqrshl"), UINT64_C(0x8a4d6a781a47059e),
     S8_INITIALIZER("arm-a64@2026-06:UQRSHL_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqrshl"), UINT64_C(0x2ccfbaab1d5abafe),
     S8_INITIALIZER("arm-a64@2026-06:UQRSHL_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqshl"), UINT64_C(0x95df4b1ce0427959),
     S8_INITIALIZER("arm-a64@2026-06:UQSHL_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uqshl"), UINT64_C(0x72614e0c7f4a79c1),
     S8_INITIALIZER("arm-a64@2026-06:UQSHL_asisdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("srhadd"), UINT64_C(0xb30bf50e9939be60),
     S8_INITIALIZER("arm-a64@2026-06:SRHADD_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("urhadd"), UINT64_C(0xd1292fa78044db86),
     S8_INITIALIZER("arm-a64@2026-06:URHADD_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uhadd"), UINT64_C(0x89b06ba4427f41f8),
     S8_INITIALIZER("arm-a64@2026-06:UHADD_asimdsame_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uhsub"), UINT64_C(0xeb24f4f933a10649),
    ...
    {S8_INITIALIZER("cnt"), UINT64_C(0x79f29c4b7493d8fc), S8_INITIALIZER("arm-a64@2026-06:CNT_asimdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("trn1"), UINT64_C(0xfdcca525def047b1), S8_INITIALIZER("arm-a64@2026-06:TRN1_asimdperm_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("trn2"), UINT64_C(0xca6a439cf2f40ac5), S8_INITIALIZER("arm-a64@2026-06:TRN2_asimdperm_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uzp1"), UINT64_C(0x0e5927756c402582), S8_INITIALIZER("arm-a64@2026-06:UZP1_asimdperm_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uzp2"), UINT64_C(0x2bebf3b6290a4e95), S8_INITIALIZER("arm-a64@2026-06:UZP2_asimdperm_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("zip1"), UINT64_C(0x7afbf184fc26aab8), S8_INITIALIZER("arm-a64@2026-06:ZIP1_asimdperm_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("zip2"), UINT64_C(0xda9df4e645b716cd), S8_INITIALIZER("arm-a64@2026-06:ZIP2_asimdperm_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("smaxp"), UINT64_C(0x96a7284d46141654), S8_INITIALIZER("arm-a64@2026-06:SMAXP_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("smax"), UINT64_C(0xcf65af24d13a372d), S8_INITIALIZER("arm-a64@2026-06:SMAX_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sminp"), UINT64_C(0xee0b782bb1ced160), S8_INITIALIZER("arm-a64@2026-06:SMINP_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("smin"), UINT64_C(0xffbd05abeecb35f), S8_INITIALIZER("arm-a64@2026-06:SMIN_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("umaxp"), UINT64_C(0x88396959a1584569), S8_INITIALIZER("arm-a64@2026-06:UMAXP_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("umax"), UINT64_C(0x5d011a59ed0fcda6), S8_INITIALIZER("arm-a64@2026-06:UMAX_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uminp"), UINT64_C(0x7d288f64c26fc2e9), S8_INITIALIZER("arm-a64@2026-06:UMINP_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
   {S8_INITIALIZER("umin"), UINT64_C(0x5d3c83c451dba6ec), S8_INITIALIZER("arm-a64@2026-06:UMIN_asimdsame_only"), 3,
    BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
    {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
     BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("addv"), UINT64_C(0x1ab2788d7662a6a1), S8_INITIALIZER("arm-a64@2026-06:ADDV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("saddlv"), UINT64_C(0xd46ae4672b69f63b), S8_INITIALIZER("arm-a64@2026-06:SADDLV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uaddlv"), UINT64_C(0xc96fa72535596354), S8_INITIALIZER("arm-a64@2026-06:UADDLV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("smaxv"), UINT64_C(0xcd22f3f3d228016c), S8_INITIALIZER("arm-a64@2026-06:SMAXV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sminv"), UINT64_C(0x2364eda2023802a2), S8_INITIALIZER("arm-a64@2026-06:SMINV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("umaxv"), UINT64_C(0xf4d19c38ba513cd6), S8_INITIALIZER("arm-a64@2026-06:UMAXV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uminv"), UINT64_C(0xf3ad2c5933a3eee9), S8_INITIALIZER("arm-a64@2026-06:UMINV_asimdall_only"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecpx"), UINT64_C(0x8562c49063307536), S8_INITIALIZER("arm-a64@2026-06:FRECPX_asisdmisc_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("frecpx"), UINT64_C(0x342fb1bb0ad35c21), S8_INITIALIZER("arm-a64@2026-06:FRECPX_asisdmiscfp16_R"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_FULLFP16,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("saba"), UINT64_C(0x255a60ff7d6455c), S8_INITIALIZER("arm-a64@2026-06:SABA_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sabd"), UINT64_C(0x2a073ca005a3dba8), S8_INITIALIZER("arm-a64@2026-06:SABD_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sadalp"), UINT64_C(0xce7ba83208138d21), S8_INITIALIZER("arm-a64@2026-06:SADALP_asimdmisc_P"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("saddlp"), UINT64_C(0x7a84faace4a630d), S8_INITIALIZER("arm-a64@2026-06:SADDLP_asimdmisc_P"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uaba"), UINT64_C(0xf0cb82f41d6dc1e1), S8_INITIALIZER("arm-a64@2026-06:UABA_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uabd"), UINT64_C(0x9ea80ca1d9ca4225), S8_INITIALIZER("arm-a64@2026-06:UABD_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uadalp"), UINT64_C(0x40d028b170dad417), S8_INITIALIZER("arm-a64@2026-06:UADALP_asimdmisc_P"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("uaddlp"), UINT64_C(0xc0aeb2fe0e2bccfc), S8_INITIALIZER("arm-a64@2026-06:UADDLP_asimdmisc_P"), 2,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("mla"), UINT64_C(0xbd3bad278da7cdcb), S8_INITIALIZER("arm-a64@2026-06:MLA_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("mls"), UINT64_C(0xfb9748a5a5710377), S8_INITIALIZER("arm-a64@2026-06:MLS_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("mul"), UINT64_C(0xa2bd52b89d3535ba), S8_INITIALIZER("arm-a64@2026-06:MUL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("pmul"), UINT64_C(0x56afa97474589285), S8_INITIALIZER("arm-a64@2026-06:PMUL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqdmulh"), UINT64_C(0x346d5eefb9e601d8), S8_INITIALIZER("arm-a64@2026-06:SQDMULH_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqdmulh"), UINT64_C(0x1efd908db4f500ed), S8_INITIALIZER("arm-a64@2026-06:SQDMULH_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrdmulh"), UINT64_C(0x19232e7906dcef5c), S8_INITIALIZER("arm-a64@2026-06:SQRDMULH_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrdmulh"), UINT64_C(0x9f8fd10fed120f41), S8_INITIALIZER("arm-a64@2026-06:SQRDMULH_asisdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrdmlah"), UINT64_C(0x3557225a108dda38),
     S8_INITIALIZER("arm-a64@2026-06:SQRDMLAH_asimdsame2_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_RDM,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrdmlah"), UINT64_C(0x26cc7e6837d3c6f),
     S8_INITIALIZER("arm-a64@2026-06:SQRDMLAH_asisdsame2_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_RDM,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrdmlsh"), UINT64_C(0x03b0c5137f14528a),
     S8_INITIALIZER("arm-a64@2026-06:SQRDMLSH_asimdsame2_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_RDM,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("sqrdmlsh"), UINT64_C(0x8f3f8e995448cec5),
     S8_INITIALIZER("arm-a64@2026-06:SQRDMLSH_asisdsame2_only"), 3, BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON_RDM,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("bif"), UINT64_C(0x9213cc7938be02c1), S8_INITIALIZER("arm-a64@2026-06:BIF_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("bit"), UINT64_C(0x16db4b3233bce730), S8_INITIALIZER("arm-a64@2026-06:BIT_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
    {S8_INITIALIZER("bsl"), UINT64_C(0x8820b97199de36f3), S8_INITIALIZER("arm-a64@2026-06:BSL_asimdsame_only"), 3,
     BUSTER_A64_DIRECT_SIMD_REQUIREMENT_NEON,
     {BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID,
      BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID, BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID}},
...
bool assembly_test_aarch64_direct_simd_spelling_at(u32 index, AssemblyAarch64DirectSIMDSpellingTest* result)
{
    ...
    *result = (AssemblyAarch64DirectSIMDSpellingTest){.mnemonic = spelling.mnemonic,
                                                      ...
                                                      .requirement = spelling.requirement,
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_direct_simd_lookup(String8 mnemonic, AssemblyInstructionInfo* result)
{
    ...
    u32 spelling_first = UINT32_MAX;
    u32 spelling_count = 0;
    AssemblyAarch64DirectSIMDSpelling first_spelling = {0};
    u32 first_row_index = UINT32_MAX;
    u32 last_spelling_index = UINT32_MAX;
    ...
    for (u32 spelling_index = 0; spelling_index < BUSTER_ARRAY_LENGTH(assembly_aarch64_direct_simd_spellings); spelling_index += 1)
    {
        ...
        if (!buster_a64_direct_simd_row(row_index, &row) || !row.executable ||
            !buster_a64_semantic_form(row.semantic_form_id, &form) ||
        ...
        if (public_operand_count != spelling.operand_count)
        {
            return false;
        }
        if (spelling_first == UINT32_MAX)
        {
            spelling_first = spelling_index;
            first_spelling = spelling;
            first_row_index = row.row_index;
        }
        else if (spelling_index != last_spelling_index + 1)
        {
            return false;
        }
        last_spelling_index = spelling_index;
        generated |= row.transform_bearing;
        spelling_count += 1;
    }
    if (spelling_first == UINT32_MAX || spelling_count > UINT8_MAX)
    {
        return false;
    }
    *result = (AssemblyInstructionInfo){
        .opcode = ASSEMBLY_OPCODE_COUNT,
        .operand_count = first_spelling.operand_count,
        .encoding_kind = ASSEMBLY_ENCODING_AARCH64_DIRECT_SIMD,
        .aarch64_direct_simd_row_index = first_row_index,
        .aarch64_direct_simd_spelling_first = spelling_first,
...
BUSTER_GLOBAL_LOCAL bool assembly_x86_target_has_evex(Target target, u16 width, u8 scalar)
{
    ...
    if (scalar)
    {
        result = avx10 || target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX512F);
    }
    else if (width == 512)
    {
        result = target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX512F) || target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX10_512);
    }
    else
    {
        result = avx10 || (target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX512F) && target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX512VL));
    }
...
BUSTER_GLOBAL_LOCAL String8 assembly_x86_mask_feature_name(AssemblyOpcode opcode)
{
    ...
    if (opcode == ASSEMBLY_OPCODE_X86_KMOVD || opcode == ASSEMBLY_OPCODE_X86_KMOVQ)
    {
        result = S8("opmask instruction requires avx512bw or avx10");
    }
    else if (opcode == ASSEMBLY_OPCODE_X86_KADDW)
    {
        result = S8("kaddw requires avx512dq or avx10");
    }
    else
    {
        result = S8("opmask instruction requires avx512f or avx10");
    }
...
BUSTER_GLOBAL_LOCAL bool assembly_x86_operand_has_high_byte(AssemblyOperand operand)
{
    ...
    if (operand.kind == ASSEMBLY_OPERAND_REGISTER)
    {
        result = operand.reg.high_byte;
    }
    else if (operand.kind == ASSEMBLY_OPERAND_MEMORY)
    {
        result = (operand.memory.has_base && operand.memory.base.high_byte) || (operand.memory.has_index && operand.memory.index.high_byte);
    }
    else
    {
        result = false;
...
BUSTER_GLOBAL_LOCAL bool assembly_x86_instruction_size(AssemblyInstruction* instruction)
{
    ...
    else if (assembly_x86_instruction_has_high_byte(*instruction) &&
    ...
    else if (instruction->amd_form)
    {
        sized = assembly_x86_amd_instruction_size(instruction, instruction->amd_form);
    }
    else if (assembly_x86_opcode_is_amx(opcode))
    {
        sized = assembly_x86_amx_instruction_size(instruction);
    }
    else if (assembly_x86_opcode_is_mask(opcode))
    {
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_direct_simd_register_parse(String8 text, BusterA64DirectSIMDArrangement arrangement, u32* number)
{
    ...
    if (dot == 1 || dot > 3 || (dot > 2 && text.pointer[1] == '0'))
    {
        return false;
    }
    u32 parsed_number = 0;
    ...
    else if (dot >= text.length || text.pointer[dot] != '.' ||
             !assembly_word_equal(string_slice(text, dot + 1, text.length), buster_a64_direct_simd_arrangement_string(arrangement)))
    {
        return false;
    }
...
typedef struct AssemblyAarch64DirectSIMDParsedRegister AssemblyAarch64DirectSIMDParsedRegister;
struct AssemblyAarch64DirectSIMDParsedRegister
{
    u32 number;
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_direct_simd_arrangement_parse(String8 text,
                                                                         BusterA64DirectSIMDArrangement* result)
{
    if (result)
    {
        for (u32 index = 1; index < BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_COUNT; index += 1)
        {
            BusterA64DirectSIMDArrangement arrangement = (BusterA64DirectSIMDArrangement)index;
            if (assembly_word_equal(text, buster_a64_direct_simd_arrangement_string(arrangement)))
            {
                *result = arrangement;
                return true;
            }
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_direct_simd_register_parse_any(String8 text,
                                                                          AssemblyAarch64DirectSIMDParsedRegister* result)
{
    text = assembly_trim(text);
    ...
    {
        arrangement = BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_B;
    }
    else if (prefix == 'h')
    {
    ...
    if (prefix == 'v')
    {
        if (dot >= text.length || text.pointer[dot] != '.' ||
            !assembly_aarch64_direct_simd_arrangement_parse(string_slice(text, dot + 1, text.length), &arrangement))
        {
            return false;
        }
        if (buster_a64_direct_simd_value_vector(number, arrangement).kind == BUSTER_A64_SEMANTIC_VM_VALUE_INVALID)
        {
            return false;
        }
    }
    ...
    *result = (AssemblyAarch64DirectSIMDParsedRegister){.number = number, .arrangement = arrangement, .prefix = prefix};
    return true;
}
...
typedef enum AssemblyAarch64DirectSIMDCandidateResult
{
    ...
    ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_FEATURE,
    ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_MATCH,
} AssemblyAarch64DirectSIMDCandidateResult;
    ...
    u32 const* conditions, u8 const* gpr_widths, BusterA64DirectSIMDInstruction* result)
{
    ...
    BusterA64DirectSIMDInstruction instruction = {.row_index = row_index, .operand_count = (u8)form.operand_count};
    for (u32 operand_index = 0; operand_index < form.operand_count; operand_index += 1)
    {
        BusterA64SemanticOperand operand = {0};
        if (!buster_a64_semantic_operand(form.operand_first + operand_index, &operand))
        ...
        else if (operand.kind == BUSTER_A64_SEMANTIC_OPERAND_SIMD_REGISTER)
        {
            ...
            if (!scalar && !vector)
            {
                BusterA64SemanticVMValue scalar_value =
                    buster_a64_direct_simd_value_scalar(registers[source], arrangements[source]);
                BusterA64SemanticVMValue vector_value =
                    buster_a64_direct_simd_value_vector(registers[source], arrangements[source]);
                scalar = scalar_value.kind != BUSTER_A64_SEMANTIC_VM_VALUE_INVALID;
                if (!scalar && vector_value.kind == BUSTER_A64_SEMANTIC_VM_VALUE_INVALID)
                {
                    return false;
                }
            }
        ...
        {
            if ((operand.flags & BUSTER_A64_SEMANTIC_FLAG_CONDITION_FIELD) == 0 || conditions[operand_index] > 15)
            {
                return false;
            }
        ...
        {
            u32 bound_register = UINT32_MAX;
            for (u32 register_index = 0; register_index < form.operand_count; register_index += 1)
            {
                BusterA64SemanticOperand candidate = {0};
                ...
                bound_register = register_index;
                break;
            }
            if (bound_register == UINT32_MAX || source_index[bound_register] >= source_count)
            {
                return false;
            }
            instruction.operands[operand_index] = buster_a64_direct_simd_value_arrangement(
                arrangements[source_index[bound_register]]);
        }
        if (instruction.operands[operand_index].kind == BUSTER_A64_SEMANTIC_VM_VALUE_INVALID)
        {
            return false;
        }
    }
    ...
    u8* gpr_widths)
{
    ...
    {
        if (token_count != spelling.operand_count || token_count > 4)
        {
            return ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
        }
        BusterA64SemanticForm form = {0};
    ...
    for (u32 operand_index = 0; operand_index < form.operand_count; operand_index += 1)
    {
        ...
        if (operand.kind == BUSTER_A64_SEMANTIC_OPERAND_CONDITION)
        {
            u64 parsed_condition = 0;
            if ((operand.flags & BUSTER_A64_SEMANTIC_FLAG_CONDITION_FIELD) == 0 || token_count <= token_index ||
                !assembly_aarch64_control_condition_parse(tokens[token_index], &parsed_condition))
            {
                return ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
            }
            conditions[operand_index] = (u32)parsed_condition;
            token_index += 1;
            continue;
        }
        if (operand.kind == BUSTER_A64_SEMANTIC_OPERAND_SIMD_REGISTER)
        {
            if (source_count >= 4 || token_count <= token_index)
            {
                return ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
            }
            AssemblyAarch64DirectSIMDParsedRegister parsed = {0};
            if (!assembly_aarch64_direct_simd_register_parse_any(tokens[token_index], &parsed))
            {
                return ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
            }
            bool scalar = (operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_SCALAR) != 0;
            bool vector = (operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_VECTOR) != 0;
            bool q = (operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_WIDTH_Q128) != 0;
            if ((vector && parsed.prefix != 'v') || (scalar && parsed.prefix == 'v') || (q && parsed.prefix != 'q'))
            {
                return ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
            }
            if (scalar)
            {
                BusterA64DirectSIMDArrangement expected = BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID;
                if ((operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_WIDTH_B8) != 0)
                    expected = BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_B;
                else if ((operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_WIDTH_H16) != 0)
                    expected = BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_H;
                else if ((operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_WIDTH_S32) != 0)
                    expected = BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_S;
                else if ((operand.flags & BUSTER_A64_SEMANTIC_FLAG_SIMD_WIDTH_D64) != 0)
                    expected = BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_D;
                if (expected != BUSTER_A64_DIRECT_SIMD_ARRANGEMENT_INVALID && parsed.arrangement != expected)
                {
                    return ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
                }
            }
            registers[source_count] = parsed.number;
            arrangements[source_count] = parsed.arrangement;
            source_count += 1;
            token_index += 1;
        }
        else if (operand.kind == BUSTER_A64_SEMANTIC_OPERAND_GPR_REGISTER)
    ...
    u32 encoded_word = 0;
    BusterA64DirectSIMDStatus status = buster_a64_direct_simd_encode(target, &instruction, &encoded_word);
    AssemblyAarch64DirectSIMDCandidateResult result;
    if (status != BUSTER_A64_DIRECT_SIMD_STATUS_OK)
    {
        result = ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_INVALID;
    }
    else
    {
        result = ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_MATCH;
    }

    return result;
}

BUSTER_GLOBAL_LOCAL bool assembly_aarch64_direct_simd_instruction_parse_generated(
    AssemblyBuilder* builder, String8 mnemonic, String8 operands_text, AssemblyInstruction* instruction,
    u32 spelling_first, u32 spelling_count, u32 line, u32 column)
{
    if (!builder || !instruction || spelling_count == 0 || spelling_count > BUSTER_ARRAY_LENGTH(assembly_aarch64_direct_simd_spellings))
    {
        return false;
    }
    String8 tokens[4] = {0};
    ...
    u32 match_count = 0;
    u32 match_row_index = UINT32_MAX;
    ...
    {
        u32 spelling_index = spelling_first + offset;
        if (spelling_index >= BUSTER_ARRAY_LENGTH(assembly_aarch64_direct_simd_spellings))
        {
            return false;
        }
        AssemblyAarch64DirectSIMDSpelling spelling = assembly_aarch64_direct_simd_spellings[spelling_index];
        if (!assembly_word_equal(mnemonic, spelling.mnemonic) || token_count != spelling.operand_count)
        {
            continue;
        }
        u32 row_index = UINT32_MAX;
        ...
        if (candidate != ASSEMBLY_AARCH64_DIRECT_SIMD_CANDIDATE_MATCH)
        {
            continue;
        }
        match_count += 1;
    ...
    if (match_count != 1)
    {
        if (feature_missing && match_count == 0)
        {
            assembly_diagnostic(builder, ASSEMBLY_DIAGNOSTIC_UNSUPPORTED_FEATURE, line, column, (u32)mnemonic.length,
                                S8("instruction requires an enabled AArch64 target feature"));
        }
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_direct_simd_instruction_parse(AssemblyBuilder* builder, String8 mnemonic,
                                                                         ...
                                                                         u32 row_index, u8 operand_count, u8 requirement,
                                                                         BusterA64DirectSIMDArrangement const* arrangements,
                                                                         u32 line, u32 column)
{
    if (!builder || !instruction)
    {
    ...
    if (token_count != operand_count || operand_count < 2 || operand_count > 4)
    {
        return false;
    }
    u32 registers[4] = {0};
    ...
    {
        if (!assembly_aarch64_direct_simd_register_parse(tokens[index], arrangements[index], &registers[index]))
        {
            return false;
        }
    }
    if (!buster_a64_direct_simd_requirement_supported(builder->target, requirement))
    {
        assembly_diagnostic(builder, ASSEMBLY_DIAGNOSTIC_UNSUPPORTED_FEATURE, line, column, (u32)mnemonic.length,
                            S8("instruction requires an enabled AArch64 target feature"));
        return false;
    ...
    for (u32 index = 0; index < operand_count; index += 1)
    {
        instruction->aarch64_direct_simd_registers[index] = (u8)registers[index];
        instruction->aarch64_direct_simd_arrangements[index] = (u8)arrangements[index];
    }
...
{
    text = assembly_trim(text);
    if (!value || text.length < 2 || (text.pointer[0] != 'c' && text.pointer[0] != 'C'))
    {
        return false;
    }
    u32 parsed = 0;
    for (u64 index = 1; index < text.length; index += 1)
    {
        ...
        if (digit < '0' || digit > '9' || parsed > (UINT32_MAX - (u32)(digit - '0')) / 10u)
        {
            return false;
        }
...
BUSTER_GLOBAL_LOCAL bool assembly_aarch64_system_pstate(String8 text, u32* op2, u32* crm, u32* op1)
{
    ...
    struct A64PStateName { String8 name; u8 op2; u8 selector_crm; u8 op1; };
    static A64PStateName const names[] = {
        {S8_INITIALIZER("spsel"), 5, 0, 0}, {S8_INITIALIZER("daifset"), 6, 0, 3},
        {S8_INITIALIZER("daifclr"), 6, 1, 3}, {S8_INITIALIZER("pan"), 4, 4, 0},
        {S8_INITIALIZER("uao"), 4, 3, 0}, {S8_INITIALIZER("ssbs"), 6, 2, 3},
        {S8_INITIALIZER("dit"), 6, 3, 3}, {S8_INITIALIZER("tco"), 6, 4, 3},
    };
    if (op2 && crm && op1)
    {
        text = assembly_trim(text);
                                                                    ...
                                                                    AssemblyInstruction* instruction, u32 row)
{
    ...
    if (row == UINT32_MAX && assembly_word_equal(mnemonic, S8("msr")))
    {
        ...
        u32 op2 = 0, selector_crm = 0, op1 = 0;
        row = assembly_aarch64_system_pstate(tokens[0], &op2, &selector_crm, &op1) ? BUSTER_AARCH64_SYSTEM_FORM_MSR_PSTATE
                                                                                     : BUSTER_AARCH64_SYSTEM_FORM_MSR;
    }
    if (row >= buster_aarch64_system_semantic_count())
    {
        return false;
    }
    BusterAarch64SystemSemanticRecord metadata = {0};
    ...
    {
        BusterAarch64SystemFieldSchema schema = {0};
        if (!buster_aarch64_system_semantic_field(row, field, &schema))
        {
            return false;
        }
    ...
    if (row == BUSTER_AARCH64_SYSTEM_FORM_MRS || row == BUSTER_AARCH64_SYSTEM_FORM_MSR)
    {
        ...
        if (token_count != 2 || !assembly_aarch64_gpr_register_parse(tokens[register_token], &reg) || reg.width != 64 ||
            !assembly_aarch64_system_reg_encoding(tokens[system_token], read, &instruction->aarch64_system_register_encoding))
        {
            return false;
        }
        ...
        if (op0 < 2 || !assembly_aarch64_system_set_field(&candidate, row, 0, reg.index, BUSTER_AARCH64_SYSTEM_FIELD_REGISTER, 5) ||
            ...
            !assembly_aarch64_system_set_field(&candidate, row, 5, op0 - 2u, BUSTER_AARCH64_SYSTEM_FIELD_O0, 1))
        {
            return false;
        }
    }
    ...
    {
        u32 op2 = 0, selector_crm = 0, op1 = 0;
        if (token_count != 2 || !assembly_aarch64_system_pstate(tokens[0], &op2, &selector_crm, &op1) ||
            ...
            !assembly_aarch64_system_set_field(&candidate, row, 2, op1, BUSTER_AARCH64_SYSTEM_FIELD_OP1, 3))
        {
            return false;
        }
        ...
        // The XML selector CRM is a representative field for the named pstate;
        // the source #imm is the architectural CRm value that must be encoded.
        BUSTER_UNUSED(selector_crm);
    }
    else if (row == BUSTER_AARCH64_SYSTEM_FORM_SYS)
    {
        ...
        if ((token_count != 4 && token_count != 5) || !assembly_aarch64_system_immediate(builder, tokens[0], 7, &op1) ||
            ...
            !assembly_aarch64_system_immediate(builder, tokens[3], 7, &op2))
        {
            return false;
        }
        candidate.fields[1].value = op2;
        candidate.fields[2].value = crm;
        candidate.fields[3].value = crn;
        candidate.fields[4].value = op1;
        if (token_count == 5)
        {
            if (!assembly_aarch64_gpr_register_parse(tokens[4], &reg) || reg.width != 64)
            {
                return false;
            }
    ...
    else if (row == BUSTER_AARCH64_SYSTEM_FORM_SYSL)
    {
        ...
        if (token_count != 5 || !assembly_aarch64_gpr_register_parse(tokens[0], &reg) || reg.width != 64 ||
            ...
            !assembly_aarch64_system_c_register(tokens[3], &crm) || !assembly_aarch64_system_immediate(builder, tokens[4], 7, &op2))
        {
            return false;
        }
        candidate.fields[0].value = reg.index;
    ...
    {
        bool named_option = assembly_aarch64_system_option(tokens[0], &value);
        bool immediate_option = !named_option && assembly_aarch64_system_immediate(builder, tokens[0], 15, &value);
        if (token_count != 1 || (!named_option && !immediate_option) ||
            (row == BUSTER_AARCH64_SYSTEM_FORM_ISB && named_option && value != 15))
        {
            return false;
        }
    ...
    {
        if (token_count > 1 || (token_count && (!assembly_aarch64_system_immediate(builder, tokens[0], 15, &value))))
        {
            return false;
        }
        candidate.fields[0].value = token_count ? value : 15;
        candidate.defaulted_mask = token_count ? 0 : 1;
    }
    else if (row == BUSTER_AARCH64_SYSTEM_FORM_HINT)
    {
        if (token_count != 1 || !assembly_aarch64_system_immediate(builder, tokens[0], 31, &value))
        {
            return false;
        }
        candidate.fields[0].value = value & 7u;
        candidate.fields[1].value = value >> 3;
    }
    else
    {
        if (token_count != 1 || !assembly_aarch64_system_immediate(builder, tokens[0], 65535, &value))
        {
            return false;
        }
        candidate.fields[0].value = value;
    ...
    u32 ignored = 0;
    bool result;
    if (!buster_aarch64_system_semantic_encode(builder->target, &candidate, &ignored))
    {
        result = false;
    }
    else
...
BUSTER_GLOBAL_LOCAL void assembly_x86_metadata_append_avx10_aliases(Target target, String8* names, u32* count, u32 capacity,
                                                                      ...
                                                                      u32 operand_count)
{
    if (target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX10_1) || target_cpu_feature_has(target, TARGET_CPU_FEATURE_X86_AVX10_2))
    {
                                                                 ...
                                                                 bool absolute, BusterX86MetadataPhysicalOperand* result)
{
    ...
    *result = (BusterX86MetadataPhysicalOperand){0};
    ...
    if (operand.kind == ASSEMBLY_OPERAND_MEMORY)
    {
        ...
        result->width = (memory.width > 64 && memory.width != 80) ? 0 : memory.width ? memory.width : (relative ? 64 : 0);
        // Width 80 is an x87 scalar element, not an aggregate vector
        // qualifier.  Keep it in the physical width field only; the
        // metadata source-width side channel is reserved for vector
        // aggregate qualifiers and would reject the mem80real rows.
        result->memory.source_width = memory.width == 80 ? 0 : memory.width;
...
{
    if (assembly_word_equal(mnemonic, S8("enter")))
    {
                                                             ...
                                                             String8* base, AssemblyInstructionInfo* base_info, u8* width)
{
    ...
    if (has_handwritten_base)
    {
        ...
        if (suffix == 'l' &&
            (info.opcode == ASSEMBLY_OPCODE_X86_FLD || info.opcode == ASSEMBLY_OPCODE_X86_FST ||
             info.opcode == ASSEMBLY_OPCODE_X86_FSTP ||
             (info.opcode >= ASSEMBLY_OPCODE_X86_FADD && info.opcode <= ASSEMBLY_OPCODE_X86_FDIVR) ||
             (info.opcode >= ASSEMBLY_OPCODE_X86_FCOM && info.opcode <= ASSEMBLY_OPCODE_X86_FCMOVCC)))
        {
            suffix_width = 64;
        }
    }
    ...
    AssemblyBuilder* builder, String8 statement, u32 line, u32 column, u64 offset, Target target, AssemblySyntax syntax)
{
    ...
    String8 first_word = string_slice(trimmed_statement, 0, first_space);
    ...
    if (wait_alias.length)
    {
        ...
        if (wait_status != BUSTER_X86_METADATA_ENCODE_SUCCESS)
        {
            return wait_status;
        }
    ...
    {
        AssemblyOperand count_operand = operands[operand_count - 1];
        if (count_operand.kind == ASSEMBLY_OPERAND_EXPRESSION && !count_operand.expression.has_symbol &&
            ((count_operand.expression.has_unsigned_addend && count_operand.expression.unsigned_addend == 1) ||
             (!count_operand.expression.has_unsigned_addend && count_operand.expression.addend == 1)))
        {
            operand_count -= 1;
        }
    }
    ...
    // information. Preserve the legacy near form (disp32) and relocation
    // width instead of allowing metadata to choose a short disp8 candidate.
    bool near_symbol_relative = assembly_word_equal(mnemonic, S8("call")) || assembly_word_equal(mnemonic, S8("jmp")) ||
                                assembly_word_equal(mnemonic, S8("xbegin")) ||
                                (mnemonic.length && (mnemonic.pointer[0] == 'j' || mnemonic.pointer[0] == 'J') &&
                                 !assembly_word_equal(mnemonic, S8("jcxz")) && !assembly_word_equal(mnemonic, S8("jecxz")) &&
                                 !assembly_word_equal(mnemonic, S8("jrcxz")));
    if (near_symbol_relative)
    {
        for (u32 index = 0; index < operand_count; index += 1)
        {
    ...
    if (implicit_att_memory && assembly_word_equal(mnemonic, S8("cldemote"))) implicit_memory_width = 8;
        ...
        implicit_memory_width = 64;
    else if (assembly_word_equal(mnemonic, S8("tileloadd")) || assembly_word_equal(mnemonic, S8("tileloaddt1")) ||
             assembly_word_equal(mnemonic, S8("tilestored")))
        // AMX tile rows use one u32 address element even when Intel syntax
        // omits a ptr qualifier.  Resolve the unsized memory before metadata
        // form selection so standard AMX_TILE rows remain distinct from the
        // feature-gated APX siblings.
        implicit_memory_width = 32;
    else if (implicit_att_memory &&
...
// The legacy integer/branch family is now encoded by the x86 metadata
// producer.  Keep the handwritten parser as the source-level syntax and alias
// front end, but route these normalized instructions through metadata before
// the byte-emitting fallback is reached.  Other x86 families remain on their
// existing handwritten paths until their own migration tranche is complete.
BUSTER_GLOBAL_LOCAL bool assembly_x86_instruction_uses_metadata_authority(AssemblyInstruction instruction)
{
    // APX legacy, NDD, NF, and PUSH2/POP2 forms use the checked metadata
    // producer.  Malformed forms fail closed at metadata selection rather than
    // reaching a handwritten byte emitter.
    bool x87_instruction = instruction.opcode >= ASSEMBLY_OPCODE_X86_FLD && instruction.opcode <= ASSEMBLY_OPCODE_X86_FWAIT;
    if (x87_instruction)
    {
        // Keep malformed x87 extended-GPR forms under the checked metadata
        // authority so they fail closed instead of reaching handwritten
        // ModRM bytes.  Valid x87 memory forms have ordinary GPR bases.
        return true;
    }
    // The handwritten AMD/XOP table is retained only for source aliases and
    // operand-shape normalization; its selected instruction forms are now
    // emitted by the checked metadata producer.
    if (instruction.amd_form)
    {
        return true;
    }
    // AMX tile/register/memory forms use the checked metadata producer; raw
    // prefix, forced-SIB, and opcode construction is not an emission path.
    if (assembly_x86_opcode_is_amx(instruction.opcode))
    {
        return true;
    }
    ...
    if (instruction.no_flags || instruction.opcode == ASSEMBLY_OPCODE_X86_APX_PUSH2 ||
        instruction.opcode == ASSEMBLY_OPCODE_X86_APX_POP2 || assembly_x86_opcode_is_apx_nf(instruction.opcode) ||
        assembly_x86_opcode_is_apx_ndd(instruction.opcode) || assembly_x86_instruction_has_extended_gpr(instruction))
    {
        return true;
    }
    switch (instruction.opcode)
    {
    case ASSEMBLY_OPCODE_X86_NOP:
    case ASSEMBLY_OPCODE_X86_RET:
    case ASSEMBLY_OPCODE_X86_INT3:
    case ASSEMBLY_OPCODE_X86_CALL:
    case ASSEMBLY_OPCODE_X86_JMP:
    case ASSEMBLY_OPCODE_X86_MOV:
    case ASSEMBLY_OPCODE_X86_ADD:
    case ASSEMBLY_OPCODE_X86_ADC:
    case ASSEMBLY_OPCODE_X86_SUB:
    case ASSEMBLY_OPCODE_X86_SBB:
    case ASSEMBLY_OPCODE_X86_AND:
    case ASSEMBLY_OPCODE_X86_OR:
    case ASSEMBLY_OPCODE_X86_XOR:
    case ASSEMBLY_OPCODE_X86_CMP:
    case ASSEMBLY_OPCODE_X86_TEST:
    case ASSEMBLY_OPCODE_X86_IMUL:
    case ASSEMBLY_OPCODE_X86_MUL:
    case ASSEMBLY_OPCODE_X86_DIV:
    case ASSEMBLY_OPCODE_X86_IDIV:
    case ASSEMBLY_OPCODE_X86_PUSH:
    case ASSEMBLY_OPCODE_X86_POP:
    case ASSEMBLY_OPCODE_X86_INC:
    case ASSEMBLY_OPCODE_X86_DEC:
    case ASSEMBLY_OPCODE_X86_NEG:
    case ASSEMBLY_OPCODE_X86_NOT:
    case ASSEMBLY_OPCODE_X86_SHL:
    case ASSEMBLY_OPCODE_X86_SHR:
    case ASSEMBLY_OPCODE_X86_SAR:
    case ASSEMBLY_OPCODE_X86_LEA:
    case ASSEMBLY_OPCODE_X86_MOVZX:
    case ASSEMBLY_OPCODE_X86_MOVSX:
    case ASSEMBLY_OPCODE_X86_MOVSXD:
    case ASSEMBLY_OPCODE_X86_ROL:
    case ASSEMBLY_OPCODE_X86_ROR:
    case ASSEMBLY_OPCODE_X86_RCL:
    case ASSEMBLY_OPCODE_X86_RCR:
    case ASSEMBLY_OPCODE_X86_SHLD:
    case ASSEMBLY_OPCODE_X86_SHRD:
    case ASSEMBLY_OPCODE_X86_CBW:
    case ASSEMBLY_OPCODE_X86_CWDE:
    case ASSEMBLY_OPCODE_X86_CDQE:
    case ASSEMBLY_OPCODE_X86_CWD:
    case ASSEMBLY_OPCODE_X86_CDQ:
    case ASSEMBLY_OPCODE_X86_CQO:
    case ASSEMBLY_OPCODE_X86_BSF:
    case ASSEMBLY_OPCODE_X86_BSR:
    case ASSEMBLY_OPCODE_X86_POPCNT:
    case ASSEMBLY_OPCODE_X86_LZCNT:
    case ASSEMBLY_OPCODE_X86_TZCNT:
    case ASSEMBLY_OPCODE_X86_BSWAP:
    case ASSEMBLY_OPCODE_X86_BT:
    case ASSEMBLY_OPCODE_X86_BTC:
    case ASSEMBLY_OPCODE_X86_BTR:
    case ASSEMBLY_OPCODE_X86_BTS:
    case ASSEMBLY_OPCODE_X86_XCHG:
    case ASSEMBLY_OPCODE_X86_XADD:
    case ASSEMBLY_OPCODE_X86_CMPXCHG:
    case ASSEMBLY_OPCODE_X86_CMPXCHG8B:
    case ASSEMBLY_OPCODE_X86_CMPXCHG16B:
                                                     ...
                                                     Target target, AssemblySyntax syntax)
{
    ...
    bool metadata_authoritative = handwritten_succeeded && target.cpu_arch == CPU_ARCH_X86_64 &&
                                  assembly_x86_instruction_uses_metadata_authority(builder->instructions[instruction_count]);
    ...
    if (!handwritten_succeeded || metadata_authoritative || unsigned_expression || handwritten_requires_metadata)
    {
        ...
        bool fallback_allowed = target.cpu_arch == CPU_ARCH_X86_64 &&
                                 (!handwritten_succeeded || metadata_authoritative || unsigned_expression || handwritten_requires_metadata);
        if (fallback_allowed)
        {
            ...
            if (metadata_authoritative)
            {
                // Once a migrated instruction has entered metadata selection, do not
                // silently resurrect handwritten bytes on a metadata failure.  Restore
                // the pre-parse state and surface the checked producer's diagnostic.
                builder->instruction_count = instruction_count;
                builder->result.symbol_count = symbol_count;
                builder->result.relocation_count = relocation_count;
                builder->result.diagnostic_count = diagnostic_count;
            ...
            if (statement.length && !segment_colon_error)
            {
                ...
                else
                {
                    ...
                    if (builder->instruction_count != instruction_count)
                    {
                        ...
                        // instruction so subsequent offsets and relocations
                        // remain aligned with emitted bytes.
                        for (u32 index = instruction_count; index < builder->instruction_count; index += 1)
                        {
                            output_offset += builder->instructions[index].size;
                        }
                    }
                }
            }
...
BUSTER_GLOBAL_LOCAL void assembly_instructions_emit(AssemblyBuilder* builder)
{
    for (u32 instruction_index = 0; instruction_index < builder->instruction_count; instruction_index += 1)
    {
        ...
        {
            u32 word = 0;
            BusterA64DirectSIMDInstruction direct_simd_instruction = {0};
            BusterA64DirectSIMDRowInfo row_info = {0};
            bool values_built = false;
            if (buster_a64_direct_simd_row(instruction->aarch64_direct_simd_row_index, &row_info) && row_info.transform_bearing)
            {
                BusterA64SemanticForm form = {0};
                u32 registers[4] = {0};
                BusterA64DirectSIMDArrangement arrangements[4] = {0};
            ...
            {
                direct_simd_instruction = (BusterA64DirectSIMDInstruction){
...
AssemblyEncodeResult assembly_encode(Arena* arena, String8 source, AssemblyEncodeOptions options)
{
    ...
    if (line_count > UINT32_MAX / 2 ||
        line_count > UINT32_MAX / BUSTER_X86_METADATA_EMIT_RELOCATION_CAPACITY ||
