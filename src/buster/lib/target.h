...
#define TARGET_CPU_FEATURE_X86_3DNOW (UINT64_C(0x20000000000000))
#define TARGET_CPU_FEATURE_X86_3DNOWA (UINT64_C(0x40000000000000))
#define TARGET_CPU_FEATURE_X86_FMA4 (UINT64_C(0x80000000000000))
#define TARGET_CPU_FEATURE_X86_LWP (UINT64_C(0x100000000000000))
#define TARGET_CPU_FEATURE_X86_TBM (UINT64_C(0x200000000000000))
#define TARGET_CPU_FEATURE_X86_XOP (UINT64_C(0x400000000000000))
// CPUID.07H:0.EDX[20] CET indirect-branch tracking; this does not model CET shadow stacks.
#define TARGET_CPU_FEATURE_X86_IBT (UINT64_C(0x800000000000000))
#define TARGET_CPU_FEATURE_X86_CLDEMOTE (UINT64_C(0x1000000000000000))
#define TARGET_CPU_FEATURE_X86_PREFETCHI (UINT64_C(0x2000000000000000))
// CPUID.07H:0.ECX[7] CET shadow stack.
#define TARGET_CPU_FEATURE_X86_SHSTK (UINT64_C(0x4000000000000000))

BUSTER_CT_CHECK(sizeof(TargetCpuFeature) == sizeof(u64));
BUSTER_CT_CHECK(TARGET_CPU_FEATURE_X86_MOVRS == UINT64_C(0x10000000000000));
BUSTER_CT_CHECK(TARGET_CPU_FEATURE_X86_XOP == UINT64_C(0x400000000000000));
