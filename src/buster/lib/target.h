...
#define TARGET_CPU_FEATURE_X86_SSE2 (UINT64_C(1) << 0)
#define TARGET_CPU_FEATURE_X86_AVX (UINT64_C(1) << 1)
#define TARGET_CPU_FEATURE_X86_AVX2 (UINT64_C(1) << 2)
#define TARGET_CPU_FEATURE_X86_AVX512F (UINT64_C(1) << 3)
#define TARGET_CPU_FEATURE_X86_AVX512VL (UINT64_C(1) << 4)
#define TARGET_CPU_FEATURE_X86_AVX10_1 (UINT64_C(1) << 5)
#define TARGET_CPU_FEATURE_X86_AVX10_2 (UINT64_C(1) << 6)
#define TARGET_CPU_FEATURE_X86_AVX10_512 (UINT64_C(1) << 7)
#define TARGET_CPU_FEATURE_X86_APX (UINT64_C(1) << 8)
#define TARGET_CPU_FEATURE_X86_AVX512BW (UINT64_C(1) << 9)
#define TARGET_CPU_FEATURE_AARCH64_NEON (UINT64_C(1) << 10)
#define TARGET_CPU_FEATURE_X86_SSE3 (UINT64_C(1) << 11)
#define TARGET_CPU_FEATURE_X86_POPCNT (UINT64_C(1) << 12)
#define TARGET_CPU_FEATURE_X86_LZCNT (UINT64_C(1) << 13)
#define TARGET_CPU_FEATURE_X86_BMI1 (UINT64_C(1) << 14)
#define TARGET_CPU_FEATURE_X86_CX16 (UINT64_C(1) << 15)
#define TARGET_CPU_FEATURE_X86_AVX512CD (UINT64_C(1) << 16)
#define TARGET_CPU_FEATURE_X86_AVX512DQ (UINT64_C(1) << 17)
#define TARGET_CPU_FEATURE_X86_AVX512IFMA (UINT64_C(1) << 18)
#define TARGET_CPU_FEATURE_X86_AVX512PF (UINT64_C(1) << 19)
#define TARGET_CPU_FEATURE_X86_AVX512ER (UINT64_C(1) << 20)
#define TARGET_CPU_FEATURE_X86_AVX512VBMI (UINT64_C(1) << 21)
#define TARGET_CPU_FEATURE_X86_AVX512VBMI2 (UINT64_C(1) << 22)
#define TARGET_CPU_FEATURE_X86_AVX512VNNI (UINT64_C(1) << 23)
#define TARGET_CPU_FEATURE_X86_AVX512BITALG (UINT64_C(1) << 24)
#define TARGET_CPU_FEATURE_X86_AVX512VPOPCNTDQ (UINT64_C(1) << 25)
#define TARGET_CPU_FEATURE_X86_AVX5124VNNIW (UINT64_C(1) << 26)
#define TARGET_CPU_FEATURE_X86_AVX5124FMAPS (UINT64_C(1) << 27)
#define TARGET_CPU_FEATURE_X86_AVX512VP2INTERSECT (UINT64_C(1) << 28)
#define TARGET_CPU_FEATURE_X86_AVX512BF16 (UINT64_C(1) << 29)
#define TARGET_CPU_FEATURE_X86_AVX512FP16 (UINT64_C(1) << 30)
#define TARGET_CPU_FEATURE_X86_GFNI (UINT64_C(1) << 31)
#define TARGET_CPU_FEATURE_X86_VAES (UINT64_C(1) << 32)
#define TARGET_CPU_FEATURE_X86_VPCLMULQDQ (UINT64_C(1) << 33)
#define TARGET_CPU_FEATURE_X86_AES (UINT64_C(1) << 34)
#define TARGET_CPU_FEATURE_X86_PCLMUL (UINT64_C(1) << 35)
#define TARGET_CPU_FEATURE_X86_AVX10_V1_AUX (UINT64_C(1) << 36)
#define TARGET_CPU_FEATURE_X86_APX_NCI_NDD_NF (UINT64_C(1) << 37)
#define TARGET_CPU_FEATURE_X86_AMX_TILE (UINT64_C(1) << 38)
#define TARGET_CPU_FEATURE_X86_AMX_INT8 (UINT64_C(1) << 39)
#define TARGET_CPU_FEATURE_X86_AMX_BF16 (UINT64_C(1) << 40)
#define TARGET_CPU_FEATURE_X86_AMX_FP16 (UINT64_C(1) << 41)
#define TARGET_CPU_FEATURE_X86_AMX_COMPLEX (UINT64_C(1) << 42)
#define TARGET_CPU_FEATURE_X86_AMX_FP8 (UINT64_C(1) << 43)
#define TARGET_CPU_FEATURE_X86_AMX_AVX512 (UINT64_C(1) << 45)
#define TARGET_CPU_FEATURE_X86_AMX_MOVRS (UINT64_C(1) << 46)
#define TARGET_CPU_FEATURE_X86_AVX_VNNI (UINT64_C(1) << 47)
#define TARGET_CPU_FEATURE_X86_AVX_VNNI_INT8 (UINT64_C(1) << 48)
#define TARGET_CPU_FEATURE_X86_AVX_VNNI_INT16 (UINT64_C(1) << 49)
#define TARGET_CPU_FEATURE_X86_AVX_IFMA (UINT64_C(1) << 50)
#define TARGET_CPU_FEATURE_X86_AVX_NE_CONVERT (UINT64_C(1) << 51)
#define TARGET_CPU_FEATURE_X86_MOVRS (UINT64_C(1) << 52)

BUSTER_CT_CHECK(sizeof(TargetCpuFeature) == sizeof(u64));
BUSTER_CT_CHECK(TARGET_CPU_FEATURE_X86_MOVRS == (UINT64_C(1) << 52));
